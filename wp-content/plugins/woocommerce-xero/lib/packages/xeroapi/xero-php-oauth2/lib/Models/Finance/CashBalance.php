...
class CashBalance implements ModelInterface, ArrayAccess
{
    ...
    protected static $setters = [
        'opening_cash_balance' => 'setOpeningCashBalance',
        'closing_cash_balance' => 'setClosingCashBalance',
        'net_cash_movement' => 'setNetCashMovement'
    ];
    ...
    protected static $getters = [
        'opening_cash_balance' => 'getOpeningCashBalance',
        'closing_cash_balance' => 'getClosingCashBalance',
        'net_cash_movement' => 'getNetCashMovement'
    ];
