...
class JournalLine implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'account_id' => 'string',
        'account_code' => 'string',
        'account_type' => '\Automattic\WooCommerce\Xero\Vendor\XeroAPI\XeroPHP\Models\Accounting\AccountType',
        'account_name' => 'string',
        'description' => 'string',
        'net_amount' => 'double',
        'gross_amount' => 'double',
        ...
        'tax_type' => 'string',
        'tax_name' => 'string',
        'tracking_categories' => '\Automattic\WooCommerce\Xero\Vendor\XeroAPI\XeroPHP\Models\Accounting\TrackingCategory[]'
    ];
     ...
     *
     * @param \Automattic\WooCommerce\Xero\Vendor\XeroAPI\XeroPHP\Models\Accounting\TrackingCategory[]|null $tracking_categories Optional Tracking Category – see Tracking. Any JournalLine can have a maximum of 2 <TrackingCategory> elements.
     *
     * @return $this
     */
