...
use Automattic\WooCommerce\Xero\Vendor\XeroAPI\XeroPHP\Models\Accounting\ModelInterface;
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        if (null === $data) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\Automattic\WooCommerce\Xero\Vendor\XeroAPI\XeroPHP\Model\\' . $data->{$discriminator};
