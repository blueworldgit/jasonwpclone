...
namespace Automattic\WooCommerce\Xero\Vendor\League\OAuth2\Client\Tool;

use Automattic\WooCommerce\Xero\Vendor\GuzzleHttp\Exception\BadResponseException;
use Automattic\WooCommerce\Xero\Vendor\GuzzleHttp\Psr7\Uri;
...
trait ProviderRedirectTrait
{
     ...
     *
     * @return Automattic\WooCommerce\Xero\Vendor\GuzzleHttp\ClientInterface
     */
     ...
     *
     * @param integer $limit
     * @return Automattic\WooCommerce\Xero\Vendor\League\OAuth2\Client\Provider\AbstractProvider
