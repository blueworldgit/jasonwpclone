...
use Automattic\WooCommerce\Xero\Vendor\League\OAuth2\Client\Grant\Exception\InvalidGrantException;
...
class GrantFactory
{
    ...
    protected function registerDefaultGrant($name)
    {
        ...
        $class = 'Automattic\\WooCommerce\\Xero\\Vendor\\League\\OAuth2\\Client\\Grant\\' . $class;
