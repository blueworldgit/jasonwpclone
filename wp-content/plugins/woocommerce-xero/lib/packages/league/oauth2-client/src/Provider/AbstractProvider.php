 ...
 *
 * Modified by woocommerce on 04-February-2026 using Strauss.
 * @see https://github.com/BrianHenryIE/strauss
 */

namespace Automattic\WooCommerce\Xero\Vendor\League\OAuth2\Client\Provider;

use Automattic\WooCommerce\Xero\Vendor\GuzzleHttp\Client as HttpClient;
use Automattic\WooCommerce\Xero\Vendor\GuzzleHttp\ClientInterface as HttpClientInterface;
use Automattic\WooCommerce\Xero\Vendor\GuzzleHttp\Exception\BadResponseException;
use InvalidArgumentException;
use Automattic\WooCommerce\Xero\Vendor\League\OAuth2\Client\Grant\AbstractGrant;
use Automattic\WooCommerce\Xero\Vendor\League\OAuth2\Client\Grant\GrantFactory;
use Automattic\WooCommerce\Xero\Vendor\League\OAuth2\Client\OptionProvider\OptionProviderInterface;
use Automattic\WooCommerce\Xero\Vendor\League\OAuth2\Client\OptionProvider\PostAuthOptionProvider;
use Automattic\WooCommerce\Xero\Vendor\League\OAuth2\Client\Provider\Exception\IdentityProviderException;
use Automattic\WooCommerce\Xero\Vendor\League\OAuth2\Client\Token\AccessToken;
use Automattic\WooCommerce\Xero\Vendor\League\OAuth2\Client\Token\AccessTokenInterface;
use Automattic\WooCommerce\Xero\Vendor\League\OAuth2\Client\Tool\ArrayAccessorTrait;
use Automattic\WooCommerce\Xero\Vendor\League\OAuth2\Client\Tool\GuardedPropertyTrait;
use Automattic\WooCommerce\Xero\Vendor\League\OAuth2\Client\Tool\QueryBuilderTrait;
use Automattic\WooCommerce\Xero\Vendor\League\OAuth2\Client\Tool\RequestFactory;
