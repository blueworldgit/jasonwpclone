...
/**
 * Get valid category structure for a vehicle
 * Generated from actual database product-category mappings
 */
function maxus_get_vehicle_categories($vehicle_slug) {
    $categories = [
        'maxus-a80-chassis' => [
            'air-intake-system' => ['air-cleaner', 'air-filter'],
            'airbag' => ['front-air-bag', 'steering-wheel-and-air-bag'],
            'antenna' => ['antenna-parts'],
            'body-interior-exterior-electronics' => ['body-interior-exterior-electronics-parts'],
            'body-lower-exterior-trim' => ['mud-guard'],
            'body-upper-exterior-trim' => ['body-exterior-trim', 'exterior-emblem-decal-nameplate'],
            'body-upper-structure' => ['baffle-plate-ware', 'outer-framing-left-side', 'outer-framing-right-side', 'panel-asm-body-si-r-end-asm-rr', 'roof-framing', 'roof-framing-chassis'],
            'body-window' => ['front-rear-window', 'side-windows'],
            'brakes' => ['brake-apply', 'brake-apply-plumbing', 'brake-modulator', 'brake-pedal', 'brake-pedals', 'brake-pedals1', 'brake-pipes', 'brake-pipes-abs', 'brake-pipes-esp', 'brake-plumbing', 'front-brake-corner', 'front-brakes', 'mechanical-parking-brakes', 'park-brake', 'park-brake-left-hand', 'park-brake-right-hand', 'rear-brake-corner', 'rear-brakes', 'rear-electric-parking-brakes', 'rear-mechanical-brakes'],
            'bumpersfascia-grille' => ['front-bumper', 'grille', 'rear-bumper', 'wheelhouse-liner'],
            'charging-energystorage' => ['moudule-electric-vehicle-control-unit'],
            'chassis-structure' => ['frame', 'front-sub-frame', 'spare-tire-bracket'],
            'communicate' => ['vehicle-tele-communication'],
            'customer-switches' => ['accessory-switches', 'accessory-switches1', 'door-switches', 'ignition-switch-and-key', 'ignition-switchand-key', 'lighting-switch', 'lighting-switch1', 'multi-function-column-switch', 'passive-entry-passive-start', 'window-lift-switch'],
            'driver-information' => ['auxiliary-information-electronics', 'clusters', 'clusters1', 'vehicle-date-recorder'],
            'emission-exhaust-system' => ['emission-exhaust-system-euro-vi', 'exhaust-system', 'exhaust-system-d20', 'exhaust-system-gasoline-engine'],
            'entertainment' => ['player', 'speaker'],
            'front-closures-front-end-sheetmetal' => ['fenders', 'hood', 'hood-lock'],
            'front-lamp' => ['front-lamp-parts'],
            'frontexterior-hvac-airflow' => ['front-end-exterior-airflow'],
            'frontinterior-hvac-airflow' => ['front-interior-control', 'front-interior-hvac-airflow', 'front-interior-hvacairflow', 'front-interior-hvacairflow-left-rudder', 'front-interior-hvacairflow-right-rudder'],
            'fuel-storage-handling' => ['coarse-filter-hardware-cuba', 'fuel-plumbing-hardware', 'fuel-plumbing-hardware-d20', 'fuel-tank-canister'],
            'hvac-powertrain-coolingin' => ['coolant-plumbing-hardware', 'refrigerant-plumbing-hardware', 'refrigerant-plumbing-hardware-electric-vehicle', 'refrigerant-plumbing-hardware-phev', 'transmission-oil-cooler-plumbing-hardware'],
            'instrument-panel-console' => ['floor-console', 'floor-console1', 'instrument-panel', 'instrument-panel-crossmember', 'instrument-panel-crossmember1', 'steering-wheel'],
            'interior-acoustic-syetem' => ['sound-insulation、heat-insulation'],
            'interior-lamp' => ['interior-lamp1'],
            'interior-trim' => ['body-lower-structure-garnish-trim', 'body-structure-garnish-trim', 'body-upper-structure-garnish-trim', 'door-trim', 'floor-trim', 'front-door-trim', 'front-side-closure-garnish-trim', 'rear-door-trim', 'rear-doortrim', 'roof-trim', 'side-closure-garnish-trim', 'side-sliding-door-trim', 'side-sliding-doortrim', 'side-trim'],
            'mounts' => ['power-assembly-installation', 'powertrain-mounts', 'powertrain-mounts-5mt', 'powertrain-mounts-6mt-6amt-9at', 'powertrain-mounts-6mt-amt'],
            'on-vehicle-attachments-tools' => ['fluids-and-lubrications', 'fluidsand-lubrications', 'lubricant', 'on-vehicle-attachments', 'on-vehicle-tools'],
            'power-energy-storage-link-wire' => ['battery-and-electric-drive-system', 'electric-drive-system', 'ept-system'],
            'power-generation' => ['accessoryaccessory-drive-euro', 'accessoryaccessory-drive-euro-5', 'coolant-pump-and-inl-otlt-tubethermostat-euro', 'coolant-pump-and-inl-otlt-tubethermostat-euro-5', 'crankshaft-rod', 'cylinder-block-accessory', 'cylinder-blockcylinder-linerflywheel', 'cylinder-head', 'damper-pulleygear-drive', 'egr-asm-euro', 'egr-asm-euro-5', 'engine-accessory', 'engine-accessory-euro-5', 'engine-euro-5', 'engine-shield', 'exhaust-elbowturbocharger-euro', 'exhaust-elbowturbocharger-euro-5', 'fuel-system', 'half-cylinder-block-group-euro-5', 'head-coverpcv', 'intake-and-exhaust-manifold-euro-5', 'intakeand-exhaust-manifold-euro', 'manifold-asm-int', 'manifold-asm-int-d20', 'oil-cooler-and-inl-otlt-tubefilter-euro', 'oil-cooler-and-inl-otlt-tubefilter-euro-5', 'sensor-harness', 'sensorharness-euro', 'sensorharness-euro-5', 'sumpoil-suction-pipedipstickbalancer-euro-5', 'sump，oil-suction-pipedipstickbalancer-euro', 'timing-drive', 'timing-drive-d20'],
            'power-signaldistribution' => ['battery-cable', 'battery-harness', 'body-harness', 'chassis-harness', 'engine-compartment-harness', 'engine-compartment-harness1', 'fusebox-cabin-compartment', 'fusebox-engine-compartment', 'ground-distribution', 'high-voltage-harness', 'high-voltage-harness-ev-phev', 'instrument-panel-harness', 'instrument-panel-harness1', 'power-outlet-cigarette-lighter-application', 'roof-harness1'],
            'power-transmission' => ['clutch-5mt', 'clutch-6mt-6amt', 'differential-wia-6mt', 'front-half-shafts', 'propeller-shaft', 'rear-axle-asm-brk', 'rear-axle-front-drive-vehicle', 'rear-drive-axle', 'rear-drive-axle-yue-jin', 'rear-driven-axle', 'transmission-accessory-5mt', 'transmission-body-5mt', 'transmission-body-wia-6mt', 'transmission-gear-5mt', 'transmission-input-shaft-and-gear-wia-6mt', 'transmission-operating-mechanism-wia-6mt', 'transmission-output-shaft-and-gear-wia-6mt', 'transmission-rvs-idler-shaft-gear-wia-6mt', 'transmissionassembly-and-csc-wia-6mt'],
            'powertrain-control-diagnostic' => ['engine-management'],
            'powertrain-driver-interface' => ['accelerator-pedal', 'clutch-apply', 'clutch-apply-5mt', 'clutch-apply-5mt1', 'clutch-apply-6mt', 'transmission-operating-mechanism-6mt', 'transmission-operating-mechanism-6mt-e5', 'transmission-shift-actuation', 'transmission-shift-actuation-6amt', 'transmission-shift-actuation-6amt-9at', 'transmission-shift-actuation-amt', 'transmission-shift-actuation-at、electric-vehicle', 'transmission-shift-actuation-mt', 'transmission-shift-actuation-mt-5mt', 'transmission-shift-actuation-mt-5mt1', 'transmission-shift-actuation-mt-6mt'],
            'rear-closure' => ['e-gate-handle-and-lock', 'endgate', 'rear-door', 'rear-door-check', 'rear-door-handle-and-door-lock', 'rear-door-hood', 'rear-door1'],
            'rear-lamp' => ['rear-lamp-parts'],
            'rear-view-mirror' => ['rear-view-mirror-parts'],
            'rearinterior-hvac-airflow' => ['interior-heating-pipe', 'interior-heating-pipe-front', 'interior-heating-pipe-rear', 'rear-interior-airflow'],
            'safety-avoidance' => ['air-bag-control-unit'],
            'safety-belt' => ['merchandise-tether-treatment', 'safety-belt-driver、copilot', 'safety-belts', 'second-row-seat-belts', 'side-panel-roof-safety-belt'],
            'sealant-body-attachment' => ['body-attachment'],
            'seats' => ['2014-schoolbus-seat', '2015-school-seat', '62-right-rudder', 'cf1-cf2-seat', 'driver-seat', 'driver-seat-left-hand', 'driver-seat-right-hand', 'driver-seat1', 'driver-seat2', 'driver-seat3', 'front-seat-left', 'front-seat-right', 'frt-dbl-seat', 'frt-dbl-seat-w-recl', 'frt-sin-seat', 'frt-sin-seat1', 'frt-sin-seat2', 'frt-sin-seat3', 'ix-seat', 'old-luxury-h-seat', 'rear-roll-double-seat', 'rr-3-seat-w-recl', 'rr-dbl-seat-w-o-recl', 'rr-dbl-seat-w-recl', 'rr-dbl-seat-w-recl1', 'rr-sin-seat-w-recl', 'rr-sin-seat-w-recl1', 'rr-sin-wide-seat', 'single-seat-type'],
            'side-closures' => ['elec-swinging-dr', 'front-door-electric-glass-regulator', 'front-door-handle-and-lock', 'front-door-handleand-lock', 'front-side-closure', 'side-sliding-door', 'side-sliding-door-handle', 'side-sliding-door-handle-and-door-lock', 'side-sliding-door-handle-and-door-lock1', 'side-sliding-door-lock', 'tnk-fil-dr'],
            'steering' => ['power-steering-plumbing-pipe', 'power-steering-plumbing-pipe1', 'redirector', 'redirector-left-hand', 'redirector-right-hand', 'steering-column'],
            'suspension' => ['five-bar-linkage-spiral-spring-rear-suspension', 'front-shock-absorber', 'front-suspension', 'rear-leaf-spring-suspension', 'rear-shock-absorber', 'rear-suspension'],
            'tirewheelswheel-trim' => ['tirewheeltrim'],
            'wiper-washer' => ['front-wiper', 'washer', 'wiper'],
        ],
        'maxus-deliver-7' => [
            'air-intake-system' => ['air-cleaner', 'air-filter'],
            'airbag' => ['front-air-bag', 'steering-wheel-and-air-bag'],
            'alternative-hvac' => ['fuel-heating-system'],
            'antenna' => ['antenna-parts'],
            'body-interior-exterior-electronics' => ['body-interior-exterior-electronics-parts'],
            'body-lower-exterior-trim' => ['assist-step', 'mud-guard'],
            'body-lower-structure' => ['body-lower-stucture'],
            'body-upper-exterior-trim' => ['body-exterior-trim', 'exterior-emblem-decal-nameplate'],
            'body-upper-structure' => ['baffle-plate-ware', 'inner-framing-left-side', 'inner-framing-right-side', 'outer-framing-left-side', 'outer-framing-right-side', 'roof-framing'],
            'body-window' => ['window'],
            'brakes' => ['brake-apply', 'brake-apply-plumbing', 'brake-modulator', 'brake-pedal', 'brake-pedals', 'brake-pedals1', 'brake-pipes', 'brake-pipes-abs', 'brake-pipes-esp', 'brake-plumbing', 'front-brake-corner', 'front-brakes', 'mechanical-parking-brakes', 'park-brake', 'park-brake-left-hand', 'park-brake-right-hand', 'rear-brakes', 'rear-disc-brake-corner', 'rear-electric-parking-brakes', 'rear-mechanical-brakes'],
            'bumpersfascia-grille' => ['front-bumper', 'grille', 'rear-bumper', 'wheelhouse-liner'],
            'charging-energystorage' => ['battery-electrical-energy-storage', 'moudule-electric-vehicle-control-unit', 'moudule-electric-vehicle-control-unit-evcc', 'power-battery-asm', 'power-inverter', 'the-internal-parts-of-power-battery'],
            'chassis-structure' => ['frame', 'front-sub-frame', 'spare-tire-device'],
            'communicate' => ['vehicle-tele-communication'],
            'customer-switches' => ['accessory-switch', 'accessory-switches', 'door-switches', 'ignition-switch-and-key', 'multi-function-column-switch', 'passive-entry-passive-start', 'window-lift-switch'],
            'driver-information' => ['auxiliary-information-electronics', 'clusters', 'clusters1', 'vehicle-date-recorder'],
            'emission-exhaust-system' => ['emission-exhaust-system-euro-vi', 'exhaust-system', 'exhaust-system-d20', 'exhaust-system-gasoline-engine'],
            'entertainment' => ['infotainment-system', 'player', 'speaker'],
            'front-closures-front-end-sheetmetal' => ['fenders', 'hood', 'hood-lock'],
            'front-lamp' => ['front-lamp-parts'],
            'frontexterior-hvac-airflow' => ['front-end-exterior-airflow'],
            'frontinterior-hvac-airflow' => ['front-interior-control', 'front-interior-hvac-airflow', 'front-interior-hvacairflow'],
            'fuel-storage-handling' => ['fuel-plumbing-hardware', 'fuel-plumbing-hardware-d20', 'fuel-tank-canister', 'urea-system', 'urea-system-d20', 'urea-system-euro-vi'],
            'hvac-powertrain-coolingin' => ['air-conditioning-compressor', 'coolant-plumbing-hardware', 'coolant-plumbing-hardware-ev', 'coolant-plumbing-hardware-fcv', 'coolant-plumbing-hardware-phev', 'refrigerant-plumbing-hardware', 'refrigerant-plumbing-hardware-electric-vehicle', 'refrigerant-plumbing-hardware-fcv', 'refrigerant-plumbing-hardware-phev', 'transmission-oil-cooler-plumbing-hardware'],
            'instrument-panel-console' => ['floor-console', 'floor-console1', 'instrument-panel', 'instrument-panel-crossmember', 'instrument-panel-crossmember-lhd', 'instrument-panel-crossmember-rhd', 'instrument-panel-lhd', 'instrument-panel-rhd', 'steering-wheel'],
            'interior-acoustic-syetem' => ['sound-insulation、heat-insulation'],
            'interior-lamp' => ['interior-lamp1'],
            'interior-trim' => ['body-lower-structure-garnish-trim', 'body-structure-garnish-trim', 'body-upper-structure-garnish-trim', 'door-trim', 'floor-trim', 'front-door-trim', 'front-side-closure-garnish-trim', 'rear-door-trim', 'rear-doortrim', 'roof-trim', 'side-closure-garnish-trim', 'side-sliding-door-trim', 'side-sliding-doortrim', 'side-trim'],
            'mounts' => ['ept-mounts', 'frame-to-body-mounts', 'power-assembly-installation', 'powertrain-mounts', 'powertrain-mounts-5mt', 'powertrain-mounts-6mt-6amt-9at', 'powertrain-mounts-6mt-amt', 'powertrain-mounts-electric-vehicle'],
            'on-vehicle-attachments-tools' => ['fluids-and-lubrications', 'fluidsand-lubrications', 'lubricant', 'on-vehicle-attachments', 'on-vehicle-tools'],
            'power-energy-storage-link-wire' => ['battery-and-electric-drive-system', 'electric-drive-system', 'ept-system', 'ept-system1', 'ept-system2', 'ept-system3', 'motor-controller-and-accessories', 'the-internal-parts-of-reduction'],
            'power-generation' => ['accessory-accessory-drive', 'accessory-accessory-drive-d20', 'accessoryaccessory-drive-euro', 'accessoryaccessory-drive-euro-5', 'block-group', 'coolant-pump-and-inl-otlt-tube-d20', 'coolant-pump-and-inl-otlt-tube-thermostat', 'crankshaft-rod', 'crankshaft-rod-d20', 'cylinder-block-accessory', 'cylinder-block-accessory-d20', 'cylinder-blockcylinder-linerflywheel', 'cylinder-head', 'cylinder-head-d20', 'damper-pulley-gear-drive', 'egr-asm', 'egr-asm-d20', 'egr-asm-euro-5', 'engine-accessory', 'engine-accessory-d20', 'engine-accessory-euro-5', 'engine-asm', 'engine-shield', 'engine-wiring-harness', 'exhaust-elbow-turbocharger', 'exhaust-elbow-turbocharger-d20', 'exhaust-elbowturbocharger-euro-5', 'fuel-system', 'head-cover-pcv', 'head-cover-pcv-d20', 'lp-egr-intake-pipe-accessory', 'manifold-asm-int', 'manifold-asm-int-d20', 'oil-cooler-and-inl-otlt-tube-filter', 'oil-cooler-and-inl-otlt-tube-filter-d20', 'oil-pumps-vacuum-pumps-vacuum-tube-components-d20', 'sensor-harness', 'sensor-harness-d20', 'sensorharness-euro', 'sensorharness-euro-5', 'shaft-balancer', 'shaft-balancer-d20', 'sump-oil-suction-pipe-dipstick', 'sump-oil-suction-pipe-dipstick-d20', 'sumpoil-suction-pipedipstickbalancer-euro-5', 'timing-drive', 'timing-drive-d20', 'uel-system-d20'],
            'power-signaldistribution' => ['battery-cable', 'battery-harness', 'battery-harnesses', 'body-accessories-harness', 'chassis-harness', 'chassis-harnesses', 'door-harness', 'engine-compartment-fuse-box', 'engine-compartment-harness', 'fusebox-cabin-compartment', 'fusebox-engine-compartment', 'high-voltage-harness', 'high-voltage-harness-ev-phev', 'high-voltage-harness-fcv', 'instrument-panel-harness', 'instrument-panel-harness1', 'power-outlet-cigarette-lighter-application', 'power-outlet-cigarette-lighter-hevice'],
            'power-transmission' => ['clutch-housing-6mt-6amt', 'clutch-housing-6mt-front-drive-6amt', 'clutch-mt', 'clutch-phev', 'differential-sagw-6amt-6mt', 'front-drive-axle', 'manual-transmission-assembly', 'manual-transmission-assembly-6mt-front-back-drive', 'propeller-shaft', 'propshaft', 'rear-axle-asm-brk', 'rear-axle-front-drive-vehicle', 'rear-drive-axle', 'rear-drive-axle-yue-jin', 'rear-driven-axle', 'rear-electric-drive-axle', 'transfer-case-part-time-4wd', 'transmission-accessory-5mt', 'transmission-accessory-6mt-front-drive', 'transmission-accessory-phev', 'transmission-accessory-sagw-6amt', 'transmission-assembly-6at', 'transmission-assembly-8at', 'transmission-body-5mt', 'transmission-body-sagw-6mt-6amt', 'transmission-csc-and-operating-mechanism-6mt-back-drive', 'transmission-differential-6mt-front-drive', 'transmission-differential-6mt-front-drive-6amt', 'transmission-fork-6mt-front-drive', 'transmission-fork-6mt-front-drive-6mt', 'transmission-fork-components-sagw-6mt-back-drive', 'transmission-main-shaft-and-gear-6mt-back-drive', 'transmission-operating-mechanism-6amt', 'transmission-operating-mechanism-6mt-front-drive', 'transmission-operating-mechanism-sagw-6mt', 'transmission-output-shaft-and-gear-wia-6mt', 'transmission-rvs-idler-shaft-gear-6mt-front-drive', 'transmission-rvs-idler-shaft-gear-6mt-front-drive-6amt', 'transmission-rvs-idler-shaft-gear-sagw-6amt-6mt', 'transmission-seal-6mt-front-drive', 'transmission-shaft-asm-6mt-front-drive', 'transmission-shaft-asm-6mt-front-drive-6amt', 'transmission-shaft-input-6mt-front-drive', 'transmission-shaft-input-6mt-front-drive-6amt', 'transmission-shaft-input-sagw-6mt-6amt', 'transmission-shaft-output-1256-6mt-front-drive', 'transmission-shaft-output-1256-6mt-front-drive-6amt', 'transmission-shaft-output-1256-sagw-6mt-6amt', 'transmission-shaft-output-34r-6mt-front-drive', 'transmission-shaft-output-34r-6mt-front-drive-6amt', 'transmission-shaft-output-34r-sagw-6mt-6amt', 'transmission-shell-6mt-6amt', 'transmission-shell-6mt-front-drive', 'transmission-shell-bearing-6mt-front-drive', 'transmission-shell-bearing-6mt-front-drive-6amt', 'transmission-shift-forks-sagw-6amt-6mt', 'transmissionassembly-and-accessory-sagw-6mt', 'transmissionassembly-tcu-and-csc-sagw-6amt'],
            'powertrain-control-diagnostic' => ['engine-management'],
            'powertrain-driver-interface' => ['accelerator-pedal', 'clutch-apply', 'clutch-apply-5mt', 'clutch-apply-5mt1', 'clutch-apply-6mt', 'transmission-operating-mechanism-6mt', 'transmission-operating-mechanism-6mt-e5', 'transmission-shift-actuation', 'transmission-shift-actuation-6amt', 'transmission-shift-actuation-6amt-9at', 'transmission-shift-actuation-amt', 'transmission-shift-actuation-at、electric-vehicle', 'transmission-shift-actuation-mt', 'transmission-shift-actuation-mt-5mt', 'transmission-shift-actuation-mt-5mt1', 'transmission-shift-actuation-mt-6mt'],
            'rear-closure' => ['endgate', 'rear-door', 'rear-door-check', 'rear-door-handle', 'rear-door-handle-and-door-lock', 'rear-door-hood', 'rear-door1'],
            'rear-lamp' => ['rear-lamp-parts'],
            'rear-view-mirror' => ['rear-view-mirror-parts'],
            'rearinterior-hvac-airflow' => ['interior-heating-pipe', 'rear-interior-airflow'],
            'safety-avoidance' => ['air-bag-control-unit', 'park-distance-control-system'],
            'safety-belt' => ['merchandise-tether-treatment', 'safety-belts', 'side-panel-roof-safety-belt'],
            'sealant-body-attachment' => ['body-attachment'],
            'seats' => ['2014-schoolbus-seat', 'frong-seat-right', 'front-double-seats', 'front-electirc-seat-left', 'front-electirc-seat-right', 'front-electrical-seat-lh', 'front-manual-seat-left', 'front-manual-seat-lh', 'front-manual-seat-rh', 'front-manual-seat-right', 'front-seat-left', 'front-seat-right', 'rear-roll-double-seat', 'rear-row-seat', 'seats-layout', 'second-row-three-seat-two-head-rest-three-head-rest', 'subdrivers-integral-double-seat', 'subdrivers-split-double-seat', 'subdrivers-split-double-seat1'],
            'side-closures' => ['elec-swinging-dr', 'front-door-electric-glass-regulator', 'front-door-handle-and-lock', 'front-door-handleand-lock', 'front-side-closure', 'rear-side-closure', 'side-sliding-door', 'side-sliding-door-guide-rail', 'side-sliding-door-handle', 'side-sliding-door-handle-and-door-lock', 'side-sliding-door-handle-and-door-lock1', 'side-sliding-door-lock', 'side-sliding-door1', 'tnk-fil-dr'],
            'steering' => ['electirc-redirector-left-right-hand', 'power-steering-plumbing-pipe', 'redirector', 'redirector-left-hand', 'redirector-left-hand-right-hand', 'redirector-right-hand', 'steering-column'],
            'suspension' => ['five-bar-linkage-spiral-spring-rear-suspension', 'front-shock-absorber', 'front-suspension', 'rear-leaf-spring-suspension', 'rear-shock-absorber', 'rear-suspension'],
            'tirewheelswheel-trim' => ['tirewheeltrim'],
            'wiper-washer' => ['front-washer', 'front-wiper', 'washer', 'washer-system', 'wiper', 'wiper-lhd', 'wiper-rhd'],
        ],
        'maxus-deliver-7-high-roof-diesel' => [
            'air-intake-system' => ['air-cleaner', 'air-filter'],
            'airbag' => ['front-air-bag', 'steering-wheel-and-air-bag'],
        ...
        'maxus-deliver-9-fwd-lux' => [
            'air-intake-system' => ['air-cleaner', 'air-filter'],
            'airbag' => ['steering-wheel-and-air-bag'],
            'antenna' => ['antenna-parts'],
            'body-interior-exterior-electronics' => ['body-interior-exterior-electronics-parts'],
            'body-lower-exterior-trim' => ['assist-step', 'mud-guard'],
            'body-lower-structure' => ['body-lower-stucture'],
            ...
            'body-upper-structure' => ['baffle-plate-ware', 'inner-framing-left-side', 'inner-framing-right-side', 'outer-framing-left-side', 'outer-framing-right-side', 'roof-framing'],
            'body-window' => ['window'],
            'brakes' => ['brake-apply', 'brake-apply-plumbing', 'brake-modulator', 'brake-pedal', 'brake-pedals', 'brake-pedals1', 'brake-pipes', 'brake-pipes-abs', 'brake-pipes-esp', 'brake-plumbing', 'front-brake-corner', 'front-brakes', 'mechanical-parking-brakes', 'park-brake', 'rear-brakes', 'rear-mechanical-brakes'],
            'bumpersfascia-grille' => ['front-bumper', 'grille', 'rear-bumper', 'wheelhouse-liner'],
            'charging-energystorage' => ['battery-electrical-energy-storage', 'moudule-electric-vehicle-control-unit', 'moudule-electric-vehicle-control-unit-evcc', 'power-inverter', 'the-internal-parts-of-power-battery-77kwh-88-8kwh'],
            'chassis-structure' => ['frame', 'front-sub-frame', 'spare-tire-device'],
            'communicate' => ['vehicle-tele-communication'],
            'customer-switches' => ['accessory-switch', 'accessory-switches', 'door-switches', 'ignition-switch-and-key', 'multi-function-column-switch', 'passive-entry-passive-start', 'window-lift-switch'],
            'driver-information' => ['auxiliary-information-electronics', 'clusters', 'vehicle-date-recorder'],
            'emission-exhaust-system' => ['emission-exhaust-system-euro-vi', 'exhaust-system', 'exhaust-system-d20', 'exhaust-system-gasoline-engine'],
            'entertainment' => ['infotainment-system', 'player', 'speaker'],
            'front-closures-front-end-sheetmetal' => ['fenders', 'hood', 'hood-lock'],
            'front-lamp' => ['front-lamp-parts'],
            'frontexterior-hvac-airflow' => ['front-end-exterior-airflow'],
            'frontinterior-hvac-airflow' => ['front-interior-control', 'front-interior-hvac-airflow', 'front-interior-hvacairflow', 'front-interior-hvacairflow-left-rudder', 'front-interior-hvacairflow-right-rudder'],
            'fuel-storage-handling' => ['coarse-filter-hardware-cuba', 'fuel-plumbing-hardware', 'fuel-plumbing-hardware-d20', 'fuel-tank-canister', 'urea-system', 'urea-system-d20', 'urea-system-euro-vi'],
            'hvac-powertrain-coolingin' => ['air-conditioning-compressor', 'coolant-plumbing-hardware', 'coolant-plumbing-hardware-ev', 'coolant-plumbing-hardware-fcv', 'coolant-plumbing-hardware-phev', 'refrigerant-plumbing-hardware', 'transmission-oil-cooler-plumbing-hardware'],
            'instrument-panel-console' => ['floor-console', 'instrument-panel', 'instrument-panel-crossmember', 'instrument-panel-crossmember-lhd', 'instrument-panel-crossmember-rhd', 'instrument-panel-lhd', 'instrument-panel-rhd', 'steering-wheel'],
            'interior-acoustic-syetem' => ['sound-insulation、heat-insulation'],
            'interior-lamp' => ['interior-lamp1'],
            'interior-trim' => ['body-lower-structure-garnish-trim', 'body-structure-garnish-trim', 'body-upper-structure-garnish-trim', 'door-trim', 'floor-trim', 'front-door-trim', 'front-side-closure-garnish-trim', 'rear-door-trim', 'roof-trim', 'side-closure-garnish-trim', 'side-sliding-door-trim', 'side-trim'],
            'mounts' => ['ept-mounts', 'power-assembly-installation', 'powertrain-mounts-5mt', 'powertrain-mounts-6mt-6amt-9at', 'powertrain-mounts-6mt-amt', 'powertrain-mounts-electric-vehicle'],
            'on-vehicle-attachments-tools' => ['fluids-and-lubrications', 'fluidsand-lubrications', 'lubricant', 'on-vehicle-attachments', 'on-vehicle-tools'],
            'power-energy-storage-link-wire' => ['battery-and-electric-drive-system', 'ept-system', 'ept-system2', 'ept-system3', 'the-internal-parts-of-reduction'],
            'power-generation' => ['accessory-accessory-drive', 'accessory-accessory-drive-d20', 'accessoryaccessory-drive-euro', 'accessoryaccessory-drive-euro-5', 'block-group', 'coolant-pump-and-inl-otlt-tube-d20', 'coolant-pump-and-inl-otlt-tube-thermostat', 'crankshaft-rod', 'crankshaft-rod-d20', 'cylinder-block-accessory', 'cylinder-block-accessory-d20', 'cylinder-blockcylinder-linerflywheel', 'cylinder-head', 'cylinder-head-d20', 'damper-pulley-gear-drive', 'egr-asm', 'egr-asm-d20', 'egr-asm-euro-5', 'engine-accessory', 'engine-accessory-euro-5', 'engine-asm', 'engine-shield', 'engine-wiring-harness', 'exhaust-elbow-turbocharger', 'exhaust-elbow-turbocharger-d20', 'exhaust-elbowturbocharger-euro-5', 'fuel-system', 'head-cover-pcv', 'head-cover-pcv-d20', 'head-coverpcv', 'lp-egr-intake-pipe-accessory', 'manifold-asm-int', 'manifold-asm-int-d20', 'oil-cooler-and-inl-otlt-tube-filter', 'oil-cooler-and-inl-otlt-tube-filter-d20', 'oil-pumps-vacuum-pumps-vacuum-tube-components-d20', 'sensor-harness', 'sensor-harness-d20', 'sensorharness-euro', 'sensorharness-euro-5', 'shaft-balancer', 'shaft-balancer-d20', 'sump-oil-suction-pipe-dipstick', 'sump-oil-suction-pipe-dipstick-d20', 'sumpoil-suction-pipedipstickbalancer-euro-5', 'timing-drive', 'timing-drive-d20', 'uel-system-d20'],
            'power-signaldistribution' => ['battery-cable', 'battery-harness', 'battery-harnesses', 'body-accessories-harness', 'chassis-harnesses', 'door-wire-harnesses', 'engine-compartment-fuse-box', 'engine-compartment-harness', 'fusebox-engine-compartment', 'high-voltage-harness', 'high-voltage-harness-ev-phev', 'instrument-panel-harness', 'instrument-panel-harness1', 'power-outlet-cigarette-lighter-application', 'power-outlet-cigarette-lighter-hevice'],
            'power-transmission' => ['clutch-housing-6mt-6amt', 'clutch-housing-6mt-front-drive-6amt', 'clutch-mt', 'clutch-phev', 'differential-sagw-6amt-6mt', 'manual-transmission-assembly', 'manual-transmission-assembly-6mt-front-back-drive', 'propeller-shaft', 'propshaft', 'rear-axle-front-drive-vehicle', 'rear-drive-axle', 'rear-drive-axle-yue-jin', 'rear-driven-axle', 'rear-electric-drive-axle', 'transmission-accessory-5mt', 'transmission-accessory-6mt-front-drive', 'transmission-accessory-phev', 'transmission-accessory-sagw-6amt', 'transmission-assembly-6at', 'transmission-assembly-8at', 'transmission-body-5mt', 'transmission-body-sagw-6mt-6amt', 'transmission-csc-and-operating-mechanism-6mt-back-drive', 'transmission-differential-6mt-front-drive', 'transmission-differential-6mt-front-drive-6amt', 'transmission-fork-6mt-front-drive', 'transmission-fork-6mt-front-drive-6mt', 'transmission-fork-components-sagw-6mt-back-drive', 'transmission-main-shaft-and-gear-6mt-back-drive', 'transmission-operating-mechanism-6amt', 'transmission-operating-mechanism-6mt-front-drive', 'transmission-operating-mechanism-sagw-6mt', 'transmission-output-shaft-and-gear-wia-6mt', 'transmission-rvs-idler-shaft-gear-6mt-front-drive', 'transmission-rvs-idler-shaft-gear-6mt-front-drive-6amt', 'transmission-rvs-idler-shaft-gear-sagw-6amt-6mt', 'transmission-seal-6mt-front-drive', 'transmission-shaft-asm-6mt-front-drive', 'transmission-shaft-asm-6mt-front-drive-6amt', 'transmission-shaft-input-6mt-front-drive', 'transmission-shaft-input-6mt-front-drive-6amt', 'transmission-shaft-input-sagw-6mt-6amt', 'transmission-shaft-output-1256-6mt-front-drive', 'transmission-shaft-output-1256-6mt-front-drive-6amt', 'transmission-shaft-output-1256-sagw-6mt-6amt', 'transmission-shaft-output-34r-6mt-front-drive', 'transmission-shaft-output-34r-6mt-front-drive-6amt', 'transmission-shaft-output-34r-sagw-6mt-6amt', 'transmission-shell-6mt-6amt', 'transmission-shell-6mt-front-drive', 'transmission-shell-bearing-6mt-front-drive', 'transmission-shell-bearing-6mt-front-drive-6amt', 'transmission-shift-forks-sagw-6amt-6mt', 'transmissionassembly-and-accessory-sagw-6mt', 'transmissionassembly-tcu-and-csc-sagw-6amt'],
            'powertrain-control-diagnostic' => ['engine-management'],
            'powertrain-driver-interface' => ['accelerator-pedal', 'clutch-apply', 'clutch-apply-5mt', 'clutch-apply-5mt1', 'clutch-apply-6mt', 'transmission-operating-mechanism-6mt', 'transmission-operating-mechanism-6mt-e5', 'transmission-shift-actuation', 'transmission-shift-actuation-6amt', 'transmission-shift-actuation-6amt-9at', 'transmission-shift-actuation-amt', 'transmission-shift-actuation-at、electric-vehicle', 'transmission-shift-actuation-mt', 'transmission-shift-actuation-mt-5mt', 'transmission-shift-actuation-mt-5mt1', 'transmission-shift-actuation-mt-6mt'],
            'rear-closure' => ['e-gate-handle-and-lock', 'endgate', 'rear-door', 'rear-door-handle', 'rear-door-handle-and-door-lock', 'rear-door-hood', 'rear-door1'],
            'rear-lamp' => ['rear-lamp-parts'],
            'rear-view-mirror' => ['rear-view-mirror-parts'],
            'rearinterior-hvac-airflow' => ['interior-heating-pipe', 'rear-interior-airflow'],
            'safety-avoidance' => ['air-bag-control-unit', 'park-distance-control', 'park-distance-control-system'],
            'safety-belt' => ['merchandise-tether-treatment', 'side-panel-roof-safety-belt'],
            'sealant-body-attachment' => ['body-attachment'],
            'seats' => ['arrangement-for-van-vehicle-uk、hong-kong', 'frong-seat-right', 'front-double-seats', 'front-manual-seat-left', 'front-manual-seat-right', 'front-seat-left', 'seat-arrangement-of-shang-jies-11-12and-14-seats-australia', 'subdrivers-integral-double-seat', 'subdrivers-split-double-seat', 'three-seats-arrangement-for-chassis-vehicle-uk、hong-kong', 'three-seats-arrangement-for-van-vehicle-australia、new-zealand', 'two-three-seats-arrangement-for-chassis-vehicle-australia、new-zealand'],
            'side-closures' => ['elec-swinging-dr', 'front-door-electric-glass-regulator', 'front-door-handle-and-lock', 'front-door-handleand-lock', 'front-side-closure', 'rear-side-closure', 'side-sliding-door', 'side-sliding-door-guide-rail', 'side-sliding-door-handle-and-door-lock', 'side-sliding-door-handle-and-door-lock1', 'side-sliding-door-lock', 'side-sliding-door1', 'tnk-fil-dr'],
            'steering' => ['electirc-redirector-left-right-hand', 'redirector', 'redirector-left-hand', 'redirector-right-hand', 'steering-column'],
            'suspension' => ['five-bar-linkage-spiral-spring-rear-suspension', 'front-shock-absorber', 'front-suspension', 'rear-leaf-spring-suspension', 'rear-shock-absorber', 'rear-suspension'],
            'tirewheelswheel-trim' => ['tirewheeltrim'],
            'wiper-washer' => ['front-wiper', 'washer-system', 'wiper', 'wiper-lhd', 'wiper-rhd'],
        ],
        'maxus-deliver-9-fwd-std' => [
            'air-intake-system' => ['air-cleaner', 'air-filter'],
            'airbag' => ['steering-wheel-and-air-bag'],
            ...
            'chassis-structure' => ['frame', 'front-sub-frame', 'spare-tire-device'],
            'communicate' => ['vehicle-tele-communication'],
            'customer-switches' => ['accessory-switch', 'accessory-switches', 'door-switches', 'ignition-switch-and-key', 'ignition-switchand-key', 'multi-function-column-switch', 'passive-entry-passive-start', 'window-lift-switch'],
            'driver-information' => ['auxiliary-information-electronics', 'clusters', 'vehicle-date-recorder'],
            'emission-exhaust-system' => ['emission-exhaust-system-euro-vi', 'exhaust-system', 'exhaust-system-d20', 'exhaust-system-gasoline-engine'],
            'entertainment' => ['infotainment-system', 'player', 'speaker'],
            'front-closures-front-end-sheetmetal' => ['fenders', 'hood', 'hood-lock'],
            ...
            'frontinterior-hvac-airflow' => ['front-interior-control', 'front-interior-hvac-airflow', 'front-interior-hvacairflow', 'front-interior-hvacairflow-left-rudder', 'front-interior-hvacairflow-right-rudder'],
            'fuel-storage-handling' => ['coarse-filter-hardware-cuba', 'fuel-plumbing-hardware', 'fuel-plumbing-hardware-d20', 'fuel-tank-canister', 'urea-system', 'urea-system-d20', 'urea-system-euro-vi'],
            'hvac-powertrain-coolingin' => ['air-conditioning-compressor', 'coolant-plumbing-hardware', 'coolant-plumbing-hardware-ev', 'coolant-plumbing-hardware-fcv', 'coolant-plumbing-hardware-phev', 'refrigerant-plumbing-hardware', 'refrigerant-plumbing-hardware-fcv', 'transmission-oil-cooler-plumbing-hardware'],
            'instrument-panel-console' => ['floor-console', 'instrument-panel', 'instrument-panel-crossmember', 'instrument-panel-crossmember-lhd', 'instrument-panel-crossmember-rhd', 'instrument-panel-lhd', 'instrument-panel-rhd', 'steering-wheel'],
            'interior-acoustic-syetem' => ['sound-insulation、heat-insulation'],
            'interior-lamp' => ['interior-lamp1'],
            'interior-trim' => ['body-lower-structure-garnish-trim', 'body-structure-garnish-trim', 'body-upper-structure-garnish-trim', 'door-trim', 'floor-trim', 'front-door-trim', 'front-side-closure-garnish-trim', 'rear-door-trim', 'roof-trim', 'side-closure-garnish-trim', 'side-sliding-door-trim', 'side-trim'],
            ...
            'power-energy-storage-link-wire' => ['battery-and-electric-drive-system', 'ept-system', 'ept-system2', 'ept-system3', 'the-internal-parts-of-reduction'],
            'power-generation' => ['accessory-accessory-drive', 'accessory-accessory-drive-d20', 'accessoryaccessory-drive-euro', 'accessoryaccessory-drive-euro-5', 'block-group', 'coolant-pump-and-inl-otlt-tube-d20', 'coolant-pump-and-inl-otlt-tube-thermostat', 'crankshaft-rod', 'crankshaft-rod-d20', 'cylinder-block-accessory', 'cylinder-block-accessory-d20', 'cylinder-blockcylinder-linerflywheel', 'cylinder-head', 'cylinder-head-d20', 'damper-pulley-gear-drive', 'egr-asm', 'egr-asm-d20', 'egr-asm-euro-5', 'engine-accessory', 'engine-accessory-euro-5', 'engine-asm', 'engine-shield', 'engine-wiring-harness', 'exhaust-elbow-turbocharger', 'exhaust-elbow-turbocharger-d20', 'exhaust-elbowturbocharger-euro-5', 'fuel-system', 'head-cover-pcv', 'head-cover-pcv-d20', 'head-coverpcv', 'lp-egr-intake-pipe-accessory', 'manifold-asm-int', 'manifold-asm-int-d20', 'oil-cooler-and-inl-otlt-tube-filter', 'oil-cooler-and-inl-otlt-tube-filter-d20', 'oil-pumps-vacuum-pumps-vacuum-tube-components-d20', 'sensor-harness', 'sensor-harness-d20', 'sensorharness-euro', 'sensorharness-euro-5', 'shaft-balancer', 'shaft-balancer-d20', 'sump-oil-suction-pipe-dipstick', 'sump-oil-suction-pipe-dipstick-d20', 'sumpoil-suction-pipedipstickbalancer-euro-5', 'timing-drive', 'timing-drive-d20', 'uel-system-d20'],
            'power-signaldistribution' => ['battery-cable', 'battery-harness', 'battery-harnesses', 'chassis-harnesses', 'door-wire-harnesses', 'engine-compartment-fuse-box', 'engine-compartment-harness', 'fusebox-engine-compartment', 'high-voltage-harness', 'high-voltage-harness-ev-phev', 'instrument-panel-harness', 'instrument-panel-harness1', 'power-outlet-cigarette-lighter-application', 'power-outlet-cigarette-lighter-hevice'],
            'power-transmission' => ['clutch-housing-6mt-6amt', 'clutch-housing-6mt-front-drive-6amt', 'clutch-mt', 'clutch-phev', 'differential-sagw-6amt-6mt', 'manual-transmission-assembly', 'manual-transmission-assembly-6mt-front-back-drive', 'propeller-shaft', 'propshaft', 'rear-axle-front-drive-vehicle', 'rear-drive-axle', 'rear-drive-axle-yue-jin', 'rear-driven-axle', 'rear-electric-drive-axle', 'transfer-case-part-time-4wd', 'transmission-accessory-5mt', 'transmission-accessory-6mt-front-drive', 'transmission-accessory-phev', 'transmission-accessory-sagw-6amt', 'transmission-assembly-6at', 'transmission-assembly-8at', 'transmission-body-5mt', 'transmission-body-sagw-6mt-6amt', 'transmission-csc-and-operating-mechanism-6mt-back-drive', 'transmission-differential-6mt-front-drive', 'transmission-differential-6mt-front-drive-6amt', 'transmission-fork-6mt-front-drive', 'transmission-fork-6mt-front-drive-6mt', 'transmission-fork-components-sagw-6mt-back-drive', 'transmission-main-shaft-and-gear-6mt-back-drive', 'transmission-operating-mechanism-6amt', 'transmission-operating-mechanism-6mt-front-drive', 'transmission-operating-mechanism-sagw-6mt', 'transmission-output-shaft-and-gear-wia-6mt', 'transmission-rvs-idler-shaft-gear-6mt-front-drive', 'transmission-rvs-idler-shaft-gear-6mt-front-drive-6amt', 'transmission-rvs-idler-shaft-gear-sagw-6amt-6mt', 'transmission-seal-6mt-front-drive', 'transmission-shaft-asm-6mt-front-drive', 'transmission-shaft-asm-6mt-front-drive-6amt', 'transmission-shaft-input-6mt-front-drive', 'transmission-shaft-input-6mt-front-drive-6amt', 'transmission-shaft-input-sagw-6mt-6amt', 'transmission-shaft-output-1256-6mt-front-drive', 'transmission-shaft-output-1256-6mt-front-drive-6amt', 'transmission-shaft-output-1256-sagw-6mt-6amt', 'transmission-shaft-output-34r-6mt-front-drive', 'transmission-shaft-output-34r-6mt-front-drive-6amt', 'transmission-shaft-output-34r-sagw-6mt-6amt', 'transmission-shell-6mt-6amt', 'transmission-shell-6mt-front-drive', 'transmission-shell-bearing-6mt-front-drive', 'transmission-shell-bearing-6mt-front-drive-6amt', 'transmission-shift-forks-sagw-6amt-6mt', 'transmissionassembly-and-accessory-sagw-6mt', 'transmissionassembly-tcu-and-csc-sagw-6amt'],
            'powertrain-control-diagnostic' => ['engine-management'],
            'powertrain-driver-interface' => ['accelerator-pedal', 'clutch-apply', 'clutch-apply-5mt', 'clutch-apply-5mt1', 'clutch-apply-6mt', 'transmission-operating-mechanism-6mt', 'transmission-operating-mechanism-6mt-e5', 'transmission-shift-actuation', 'transmission-shift-actuation-6amt', 'transmission-shift-actuation-6amt-9at', 'transmission-shift-actuation-amt', 'transmission-shift-actuation-at、electric-vehicle', 'transmission-shift-actuation-mt', 'transmission-shift-actuation-mt-5mt', 'transmission-shift-actuation-mt-5mt1', 'transmission-shift-actuation-mt-6mt'],
            'rear-closure' => ['e-gate-handle-and-lock', 'endgate', 'rear-door', 'rear-door-handle', 'rear-door-handle-and-door-lock', 'rear-door-hood', 'rear-door1'],
            'rear-lamp' => ['rear-lamp-parts'],
            ...
            'safety-belt' => ['merchandise-tether-treatment', 'side-panel-roof-safety-belt'],
            'sealant-body-attachment' => ['body-attachment'],
            'seats' => ['arrangement-for-van-vehicle-uk、hong-kong', 'frong-seat-right', 'front-double-seats', 'front-manual-seat-left', 'front-manual-seat-right', 'front-seat-left', 'front-seat-right', 'seat-arrangement-of-shang-jies-11-12and-14-seats-australia', 'subdrivers-integral-double-seat', 'subdrivers-split-double-seat', 'three-seats-arrangement-for-chassis-vehicle-uk、hong-kong', 'three-seats-arrangement-for-van-vehicle-australia、new-zealand', 'two-three-seats-arrangement-for-chassis-vehicle-australia、new-zealand'],
            'side-closures' => ['elec-swinging-dr', 'front-door-electric-glass-regulator', 'front-door-handle-and-lock', 'front-door-handleand-lock', 'front-side-closure', 'rear-side-closure', 'side-sliding-door', 'side-sliding-door-guide-rail', 'side-sliding-door-handle-and-door-lock', 'side-sliding-door-handle-and-door-lock1', 'side-sliding-door-lock', 'side-sliding-door1', 'tnk-fil-dr'],
            'steering' => ['electirc-redirector-left-right-hand', 'redirector', 'redirector-left-hand', 'redirector-right-hand', 'steering-column'],
            'suspension' => ['five-bar-linkage-spiral-spring-rear-suspension', 'front-shock-absorber', 'front-suspension', 'rear-leaf-spring-suspension', 'rear-shock-absorber', 'rear-suspension'],
            'tirewheelswheel-trim' => ['tirewheeltrim'],
        ...
        'maxus-deliver-9-rwd-chassis' => [
            ...
            'body-lower-exterior-trim' => ['assist-step', 'mud-guard'],
            'body-lower-structure' => ['body-lower-stucture'],
            'body-upper-exterior-trim' => ['body-exterior-trim'],
            'body-upper-structure' => ['baffle-plate-ware', 'inner-framing-left-side', 'inner-framing-right-side', 'outer-framing-left-side', 'outer-framing-right-side', 'rear-panel', 'roof-framing'],
            'body-window' => ['window'],
            'brakes' => ['brake-apply', 'brake-apply-plumbing', 'brake-modulator', 'brake-pedal', 'brake-pedals', 'brake-pedals1', 'brake-pipes', 'brake-pipes-abs', 'brake-pipes-esp', 'brake-plumbing', 'front-brakes', 'mechanical-parking-brakes', 'park-brake', 'rear-brake-corner', 'rear-brakes', 'rear-disc-brake-corner', 'rear-electric-parking-brakes', 'rear-mechanical-brakes'],
            'bumpersfascia-grille' => ['front-bumper', 'grille', 'rear-bumper', 'wheelhouse-liner'],
            'charging-energystorage' => ['battery-electrical-energy-storage', 'moudule-electric-vehicle-control-unit', 'moudule-electric-vehicle-control-unit-evcc', 'power-inverter', 'the-internal-parts-of-power-battery-77kwh-88-8kwh'],
            'chassis-structure' => ['frame', 'front-sub-frame', 'spare-tire-device'],
            'communicate' => ['vehicle-tele-communication'],
            'customer-switches' => ['accessory-switch', 'accessory-switches', 'ignition-switch-and-key', 'ignition-switchand-key', 'multi-function-column-switch', 'passive-entry-passive-start', 'window-lift-switch'],
            'driver-information' => ['auxiliary-information-electronics', 'clusters', 'vehicle-date-recorder'],
            'emission-exhaust-system' => ['emission-exhaust-system-euro-vi', 'exhaust-system', 'exhaust-system-d20', 'exhaust-system-gasoline-engine'],
            'entertainment' => ['infotainment-system', 'player', 'speaker'],
            'front-closures-front-end-sheetmetal' => ['fenders', 'hood', 'hood-lock'],
            ...
            'interior-acoustic-syetem' => ['sound-insulation、heat-insulation'],
            'interior-lamp' => ['interior-lamp1'],
            'interior-trim' => ['body-lower-structure-garnish-trim', 'body-structure-garnish-trim', 'body-upper-structure-garnish-trim', 'door-trim', 'floor-trim', 'front-door-trim', 'front-side-closure-garnish-trim', 'roof-trim', 'side-closure-garnish-trim', 'side-sliding-door-trim', 'side-trim'],
            'mounts' => ['ept-mounts', 'frame-to-body-mounts', 'power-assembly-installation', 'powertrain-mounts', 'powertrain-mounts-6mt-6amt-9at'],
            'on-vehicle-attachments-tools' => ['fluids-and-lubrications', 'fluidsand-lubrications', 'lubricant', 'on-vehicle-attachments', 'on-vehicle-tools'],
            'power-energy-storage-link-wire' => ['battery-and-electric-drive-system', 'electric-drive-system1', 'ept-system', 'ept-system2', 'ept-system3', 'the-internal-parts-of-reduction'],
            'power-generation' => ['accessory-accessory-drive-d20', 'accessoryaccessory-drive-euro', 'block-group', 'coolant-pump-and-inl-otlt-tube-d20', 'coolant-pump-and-inl-otlt-tube-thermostat', 'crankshaft-rod', 'crankshaft-rod-d20', 'cylinder-block-accessory', 'cylinder-block-accessory-d20', 'cylinder-blockcylinder-linerflywheel', 'cylinder-head', 'cylinder-head-d20', 'damper-pulley-gear-drive', 'egr-asm', 'egr-asm-d20', 'egr-asm-euro-5', 'engine-accessory', 'engine-accessory-d20', 'engine-accessory-euro-5', 'engine-asm', 'engine-shield', 'engine-wiring-harness', 'exhaust-elbow-turbocharger', 'exhaust-elbow-turbocharger-d20', 'exhaust-elbowturbocharger-euro-5', 'fuel-system', 'head-cover-pcv', 'head-cover-pcv-d20', 'head-coverpcv', 'lp-egr-intake-pipe-accessory', 'manifold-asm-int', 'manifold-asm-int-d20', 'oil-cooler-and-inl-otlt-tube-filter', 'oil-cooler-and-inl-otlt-tube-filter-d20', 'oil-pumps-vacuum-pumps-vacuum-tube-components-d20', 'sensor-harness', 'sensor-harness-d20', 'sensorharness-euro', 'sensorharness-euro-5', 'shaft-balancer', 'shaft-balancer-d20', 'sump-oil-suction-pipe-dipstick', 'sump-oil-suction-pipe-dipstick-d20', 'sumpoil-suction-pipedipstickbalancer-euro-5', 'timing-drive', 'timing-drive-d20', 'uel-system-d20'],
            'power-signaldistribution' => ['battery-cable', 'battery-harness', 'battery-harnesses', 'chassis-harness', 'chassis-harnesses', 'door-wire-harnesses', 'engine-compartment-fuse-box', 'engine-compartment-harness', 'fusebox-engine-compartment', 'high-voltage-harness-ev-phev', 'instrument-panel-harness', 'instrument-panel-harness1', 'power-outlet-cigarette-lighter-application', 'power-outlet-cigarette-lighter-hevice'],
            'power-transmission' => ['clutch-housing-6mt-6amt', 'clutch-mt', 'front-drive-axle', 'hybrid-transmission-assembly', 'manual-transmission-assembly', 'manual-transmission-assembly-6mt-front-back-drive', 'propeller-shaft', 'propshaft', 'rear-axle-asm-brk', 'rear-axle-front-drive-vehicle', 'rear-drive-axle', 'rear-drive-axle-yue-jin', 'rear-driven-axle', 'rear-electric-drive-axle', 'transfer-case-part-time-4wd', 'transmission-accessory-5mt', 'transmission-accessory-6mt-front-drive', 'transmission-accessory-phev', 'transmission-accessory-sagw-6amt', 'transmission-assembly-6at', 'transmission-assembly-8at', 'transmission-assembly-sagw-6mt', 'transmission-csc-and-operating-mechanism-6mt-back-drive', 'transmission-differential-6mt-front-drive-6amt', 'transmission-fork-components-sagw-6mt-back-drive', 'transmission-main-shaft-and-gear-6mt-back-drive', 'transmission-operating-mechanism-6amt', 'transmission-operating-mechanism-6mt-front-drive', 'transmission-operating-mechanism-sagw-6mt', 'transmission-seal-6mt-front-drive', 'transmission-shaft-input-6mt-front-drive', 'transmission-shaft-input-6mt-front-drive-6amt', 'transmission-shaft-input-sagw-6mt-6amt', 'transmission-shaft-output-1256-6mt-front-drive', 'transmission-shaft-output-1256-6mt-front-drive-6amt', 'transmission-shaft-output-1256-sagw-6mt-6amt', 'transmission-shaft-output-34r-6mt-front-drive', 'transmission-shaft-output-34r-6mt-front-drive-6amt', 'transmission-shaft-output-34r-sagw-6mt-6amt', 'transmission-shell-6mt-6amt', 'transmission-shift-forks-sagw-6amt-6mt', 'transmissionassembly-and-accessory-sagw-6mt'],
            'powertrain-control-diagnostic' => ['engine-management'],
            'powertrain-driver-interface' => ['accelerator-pedal', 'clutch-apply', 'clutch-apply-5mt', 'clutch-apply-5mt1', 'clutch-apply-6mt', 'transmission-operating-mechanism-6mt', 'transmission-operating-mechanism-6mt-e5', 'transmission-shift-actuation', 'transmission-shift-actuation-6amt', 'transmission-shift-actuation-6amt-9at', 'transmission-shift-actuation-amt', 'transmission-shift-actuation-at、electric-vehicle', 'transmission-shift-actuation-mt', 'transmission-shift-actuation-mt-5mt', 'transmission-shift-actuation-mt-5mt1', 'transmission-shift-actuation-mt-6mt'],
            'rear-closure' => ['e-gate-handle-and-lock', 'endgate', 'rear-door', 'rear-door-handle', 'rear-door-handle-and-door-lock', 'rear-door-hood', 'rear-door1'],
            'rear-lamp' => ['rear-lamp-parts'],
            ...
            'rearinterior-hvac-airflow' => ['interior-heating-pipe', 'rear-interior-airflow'],
            'safety-avoidance' => ['air-bag-control-unit', 'park-distance-control-system'],
            'safety-belt' => ['side-panel-roof-safety-belt'],
            'sealant-body-attachment' => ['body-attachment'],
            'seats' => ['arrangement-for-van-vehicle-uk、hong-kong', 'frong-seat-right', 'front-double-seats', 'front-manual-seat-left', 'front-manual-seat-right', 'front-seat-left', 'front-seat-right', 'seat-arrangement-of-shang-jies-11-12and-14-seats-australia', 'subdrivers-integral-double-seat', 'subdrivers-split-double-seat', 'three-seats-arrangement-for-chassis-vehicle-uk、hong-kong', 'three-seats-arrangement-for-van-vehicle-australia、new-zealand', 'two-three-seats-arrangement-for-chassis-vehicle-australia、new-zealand'],
            'side-closures' => ['elec-swinging-dr', 'front-door-electric-glass-regulator', 'front-door-handle-and-lock', 'front-door-handleand-lock', 'front-side-closure', 'rear-side-closure', 'side-sliding-door', 'side-sliding-door-handle-and-door-lock', 'side-sliding-door-handle-and-door-lock1', 'side-sliding-door-lock', 'side-sliding-door1', 'tnk-fil-dr'],
            'steering' => ['electirc-redirector-left-right-hand', 'redirector', 'redirector-left-hand', 'redirector-left-hand-right-hand', 'redirector-right-hand', 'steering-column'],
            'suspension' => ['five-bar-linkage-spiral-spring-rear-suspension', 'front-shock-absorber', 'front-suspension', 'rear-leaf-spring-suspension', 'rear-shock-absorber', 'rear-suspension'],
            'tirewheelswheel-trim' => ['tirewheeltrim'],
            'wiper-washer' => ['front-wiper', 'washer-system', 'wiper', 'wiper-lhd', 'wiper-rhd'],
        ],
        'maxus-deliver-9-rwd-lux' => [
            ...
            'on-vehicle-attachments-tools' => ['fluids-and-lubrications', 'fluidsand-lubrications', 'lubricant', 'on-vehicle-attachments', 'on-vehicle-tools'],
            'power-energy-storage-link-wire' => ['battery-and-electric-drive-system', 'electric-drive-system1', 'ept-system', 'ept-system2', 'ept-system3', 'the-internal-parts-of-reduction'],
            'power-generation' => ['accessory-accessory-drive', 'accessory-accessory-drive-d20', 'accessoryaccessory-drive-euro', 'accessoryaccessory-drive-euro-5', 'block-group', 'coolant-pump-and-inl-otlt-tube-d20', 'coolant-pump-and-inl-otlt-tube-thermostat', 'crankshaft-rod', 'crankshaft-rod-d20', 'cylinder-block-accessory', 'cylinder-block-accessory-d20', 'cylinder-blockcylinder-linerflywheel', 'cylinder-head', 'cylinder-head-d20', 'damper-pulley-gear-drive', 'egr-asm', 'egr-asm-d20', 'egr-asm-euro-5', 'engine-accessory', 'engine-accessory-d20', 'engine-accessory-euro-5', 'engine-asm', 'engine-shield', 'engine-wiring-harness', 'exhaust-elbow-turbocharger', 'exhaust-elbow-turbocharger-d20', 'exhaust-elbowturbocharger-euro-5', 'fuel-system', 'head-cover-pcv', 'head-cover-pcv-d20', 'head-coverpcv', 'manifold-asm-int', 'manifold-asm-int-d20', 'oil-cooler-and-inl-otlt-tube-filter', 'oil-cooler-and-inl-otlt-tube-filter-d20', 'oil-pumps-vacuum-pumps-vacuum-tube-components-d20', 'sensor-harness', 'sensor-harness-d20', 'sensorharness-euro', 'sensorharness-euro-5', 'shaft-balancer', 'shaft-balancer-d20', 'sump-oil-suction-pipe-dipstick', 'sump-oil-suction-pipe-dipstick-d20', 'sumpoil-suction-pipedipstickbalancer-euro-5', 'timing-drive', 'timing-drive-d20', 'uel-system-d20'],
            'power-signaldistribution' => ['battery-cable', 'battery-harness', 'battery-harnesses', 'body-accessories-harness', 'chassis-harness', 'chassis-harnesses', 'door-wire-harnesses', 'engine-compartment-fuse-box', 'engine-compartment-harness', 'fusebox-engine-compartment', 'high-voltage-harness', 'high-voltage-harness-ev-phev', 'instrument-panel-harness', 'instrument-panel-harness1', 'power-outlet-cigarette-lighter-application', 'power-outlet-cigarette-lighter-hevice'],
            'power-transmission' => ['clutch-housing-6mt-6amt', 'clutch-mt', 'clutch-phev', 'front-drive-axle', 'hybrid-transmission-assembly', 'manual-transmission-assembly', 'manual-transmission-assembly-6mt-front-back-drive', 'propeller-shaft', 'propshaft', 'rear-axle-asm-brk', 'rear-axle-front-drive-vehicle', 'rear-drive-axle', 'rear-drive-axle-yue-jin', 'rear-driven-axle', 'rear-electric-drive-axle', 'transfer-case-part-time-4wd', 'transmission-accessory-5mt', 'transmission-accessory-6mt-front-drive', 'transmission-accessory-phev', 'transmission-accessory-sagw-6amt', 'transmission-assembly-6at', 'transmission-assembly-8at', 'transmission-assembly-sagw-6mt', 'transmission-csc-and-operating-mechanism-6mt-back-drive', 'transmission-differential-6mt-front-drive-6amt', 'transmission-fork-components-sagw-6mt-back-drive', 'transmission-main-shaft-and-gear-6mt-back-drive', 'transmission-operating-mechanism-6amt', 'transmission-operating-mechanism-6mt-front-drive', 'transmission-operating-mechanism-sagw-6mt', 'transmission-seal-6mt-front-drive', 'transmission-shaft-input-6mt-front-drive', 'transmission-shaft-input-6mt-front-drive-6amt', 'transmission-shaft-input-sagw-6mt-6amt', 'transmission-shaft-output-1256-6mt-front-drive', 'transmission-shaft-output-1256-6mt-front-drive-6amt', 'transmission-shaft-output-1256-sagw-6mt-6amt', 'transmission-shaft-output-34r-6mt-front-drive', 'transmission-shaft-output-34r-6mt-front-drive-6amt', 'transmission-shaft-output-34r-sagw-6mt-6amt', 'transmission-shell-6mt-6amt', 'transmission-shift-forks-sagw-6amt-6mt', 'transmissionassembly-and-accessory-sagw-6mt'],
            'powertrain-control-diagnostic' => ['engine-management'],
            'powertrain-driver-interface' => ['accelerator-pedal', 'clutch-apply', 'clutch-apply-5mt', 'clutch-apply-5mt1', 'clutch-apply-6mt', 'transmission-operating-mechanism-6mt', 'transmission-operating-mechanism-6mt-e5', 'transmission-shift-actuation', 'transmission-shift-actuation-6amt', 'transmission-shift-actuation-6amt-9at', 'transmission-shift-actuation-amt', 'transmission-shift-actuation-at、electric-vehicle', 'transmission-shift-actuation-mt', 'transmission-shift-actuation-mt-5mt', 'transmission-shift-actuation-mt-5mt1', 'transmission-shift-actuation-mt-6mt'],
            'rear-closure' => ['endgate', 'rear-door', 'rear-door-handle', 'rear-door-handle-and-door-lock', 'rear-door-hood'],
            'rear-lamp' => ['rear-lamp-parts'],
            'rear-view-mirror' => ['rear-view-mirror-parts'],
            'rearinterior-hvac-airflow' => ['interior-heating-pipe', 'rear-interior-airflow'],
            'safety-avoidance' => ['air-bag-control-unit', 'park-distance-control-system'],
            ...
            'sealant-body-attachment' => ['body-attachment'],
            'seats' => ['arrangement-for-van-vehicle-uk、hong-kong', 'frong-seat-right', 'front-double-seats', 'front-manual-seat-left', 'front-manual-seat-right', 'front-seat-left', 'front-seat-right', 'seat-arrangement-of-shang-jies-11-12and-14-seats-australia', 'subdrivers-integral-double-seat', 'subdrivers-split-double-seat', 'three-seats-arrangement-for-chassis-vehicle-uk、hong-kong', 'three-seats-arrangement-for-van-vehicle-australia、new-zealand', 'two-three-seats-arrangement-for-chassis-vehicle-australia、new-zealand'],
            'side-closures' => ['elec-swinging-dr', 'front-door-electric-glass-regulator', 'front-door-handle-and-lock', 'front-door-handleand-lock', 'front-side-closure', 'rear-side-closure', 'side-sliding-door', 'side-sliding-door-handle-and-door-lock', 'side-sliding-door-handle-and-door-lock1', 'side-sliding-door1', 'tnk-fil-dr'],
            'steering' => ['electirc-redirector-left-right-hand', 'redirector', 'redirector-left-hand', 'redirector-left-hand-right-hand', 'redirector-right-hand', 'steering-column'],
            'suspension' => ['five-bar-linkage-spiral-spring-rear-suspension', 'front-shock-absorber', 'front-suspension', 'rear-leaf-spring-suspension', 'rear-shock-absorber', 'rear-suspension'],
            'tirewheelswheel-trim' => ['tirewheeltrim'],
            'wiper-washer' => ['front-wiper', 'washer-system', 'wiper', 'wiper-lhd', 'wiper-rhd'],
        ...
        'maxus-deliver-9-rwd-std' => [
            ...
            'frontinterior-hvac-airflow' => ['front-interior-control', 'front-interior-hvac-airflow', 'front-interior-hvacairflow', 'front-interior-hvacairflow-left-rudder', 'front-interior-hvacairflow-right-rudder'],
            'fuel-storage-handling' => ['coarse-filter-hardware-cuba', 'fuel-plumbing-hardware', 'fuel-plumbing-hardware-d20', 'fuel-tank-canister', 'urea-system', 'urea-system-d20', 'urea-system-euro-vi'],
            'hvac-powertrain-coolingin' => ['air-conditioning-compressor', 'coolant-plumbing-hardware', 'coolant-plumbing-hardware-ev', 'coolant-plumbing-hardware-fcv', 'coolant-plumbing-hardware-phev', 'refrigerant-plumbing-hardware', 'refrigerant-plumbing-hardware-electric-vehicle', 'refrigerant-plumbing-hardware-fcv', 'transmission-oil-cooler-plumbing-hardware'],
            'instrument-panel-console' => ['floor-console', 'instrument-panel', 'instrument-panel-crossmember', 'instrument-panel-crossmember-lhd', 'instrument-panel-crossmember-rhd', 'instrument-panel-lhd', 'instrument-panel-rhd', 'steering-wheel'],
            'interior-acoustic-syetem' => ['sound-insulation、heat-insulation'],
            'interior-lamp' => ['interior-lamp1'],
            'interior-trim' => ['body-lower-structure-garnish-trim', 'body-structure-garnish-trim', 'body-upper-structure-garnish-trim', 'door-trim', 'floor-trim', 'front-door-trim', 'front-side-closure-garnish-trim', 'rear-door-trim', 'roof-trim', 'side-sliding-door-trim', 'side-trim'],
            'mounts' => ['ept-mounts', 'power-assembly-installation', 'powertrain-mounts', 'powertrain-mounts-6mt-6amt-9at'],
            'on-vehicle-attachments-tools' => ['fluids-and-lubrications', 'fluidsand-lubrications', 'lubricant', 'on-vehicle-attachments', 'on-vehicle-tools'],
            'power-energy-storage-link-wire' => ['battery-and-electric-drive-system', 'electric-drive-system1', 'ept-system', 'ept-system2', 'ept-system3', 'the-internal-parts-of-reduction'],
            'power-generation' => ['accessory-accessory-drive', 'accessory-accessory-drive-d20', 'accessoryaccessory-drive-euro', 'accessoryaccessory-drive-euro-5', 'block-group', 'coolant-pump-and-inl-otlt-tube-d20', 'coolant-pump-and-inl-otlt-tube-thermostat', 'crankshaft-rod', 'crankshaft-rod-d20', 'cylinder-block-accessory', 'cylinder-block-accessory-d20', 'cylinder-blockcylinder-linerflywheel', 'cylinder-head', 'cylinder-head-d20', 'damper-pulley-gear-drive', 'egr-asm', 'egr-asm-d20', 'egr-asm-euro-5', 'engine-accessory', 'engine-accessory-d20', 'engine-accessory-euro-5', 'engine-shield', 'engine-wiring-harness', 'exhaust-elbow-turbocharger', 'exhaust-elbow-turbocharger-d20', 'exhaust-elbowturbocharger-euro-5', 'fuel-system', 'head-cover-pcv', 'head-cover-pcv-d20', 'head-coverpcv', 'lp-egr-intake-pipe-accessory', 'manifold-asm-int', 'manifold-asm-int-d20', 'oil-cooler-and-inl-otlt-tube-filter', 'oil-cooler-and-inl-otlt-tube-filter-d20', 'oil-pumps-vacuum-pumps-vacuum-tube-components-d20', 'sensor-harness', 'sensor-harness-d20', 'sensorharness-euro', 'sensorharness-euro-5', 'shaft-balancer', 'shaft-balancer-d20', 'sump-oil-suction-pipe-dipstick', 'sump-oil-suction-pipe-dipstick-d20', 'sumpoil-suction-pipedipstickbalancer-euro-5', 'timing-drive', 'timing-drive-d20', 'uel-system-d20'],
            'power-signaldistribution' => ['battery-cable', 'battery-harness', 'battery-harnesses', 'chassis-harness', 'chassis-harnesses', 'door-wire-harnesses', 'engine-compartment-fuse-box', 'engine-compartment-harness', 'fusebox-engine-compartment', 'high-voltage-harness', 'high-voltage-harness-ev-phev', 'instrument-panel-harness', 'instrument-panel-harness1', 'power-outlet-cigarette-lighter-application', 'power-outlet-cigarette-lighter-hevice'],
            'power-transmission' => ['clutch-housing-6mt-6amt', 'clutch-mt', 'clutch-phev', 'hybrid-transmission-assembly', 'manual-transmission-assembly', 'manual-transmission-assembly-6mt-front-back-drive', 'propeller-shaft', 'propshaft', 'rear-axle-asm-brk', 'rear-axle-front-drive-vehicle', 'rear-drive-axle', 'rear-drive-axle-yue-jin', 'rear-driven-axle', 'rear-electric-drive-axle', 'transfer-case-part-time-4wd', 'transmission-accessory-5mt', 'transmission-accessory-6mt-front-drive', 'transmission-accessory-phev', 'transmission-accessory-sagw-6amt', 'transmission-assembly-6at', 'transmission-assembly-8at', 'transmission-assembly-sagw-6mt', 'transmission-csc-and-operating-mechanism-6mt-back-drive', 'transmission-differential-6mt-front-drive-6amt', 'transmission-fork-components-sagw-6mt-back-drive', 'transmission-main-shaft-and-gear-6mt-back-drive', 'transmission-operating-mechanism-6amt', 'transmission-operating-mechanism-6mt-front-drive', 'transmission-operating-mechanism-sagw-6mt', 'transmission-seal-6mt-front-drive', 'transmission-shaft-input-6mt-front-drive', 'transmission-shaft-input-6mt-front-drive-6amt', 'transmission-shaft-input-sagw-6mt-6amt', 'transmission-shaft-output-1256-6mt-front-drive', 'transmission-shaft-output-1256-6mt-front-drive-6amt', 'transmission-shaft-output-1256-sagw-6mt-6amt', 'transmission-shaft-output-34r-6mt-front-drive', 'transmission-shaft-output-34r-6mt-front-drive-6amt', 'transmission-shaft-output-34r-sagw-6mt-6amt', 'transmission-shell-6mt-6amt', 'transmission-shift-forks-sagw-6amt-6mt', 'transmissionassembly-and-accessory-sagw-6mt'],
            'powertrain-control-diagnostic' => ['engine-management'],
            'powertrain-driver-interface' => ['accelerator-pedal', 'clutch-apply', 'clutch-apply-5mt', 'clutch-apply-5mt1', 'clutch-apply-6mt', 'transmission-operating-mechanism-6mt', 'transmission-operating-mechanism-6mt-e5', 'transmission-shift-actuation', 'transmission-shift-actuation-6amt', 'transmission-shift-actuation-6amt-9at', 'transmission-shift-actuation-amt', 'transmission-shift-actuation-at、electric-vehicle', 'transmission-shift-actuation-mt', 'transmission-shift-actuation-mt-5mt', 'transmission-shift-actuation-mt-5mt1', 'transmission-shift-actuation-mt-6mt'],
            'rear-closure' => ['e-gate-handle-and-lock', 'endgate', 'rear-door', 'rear-door-handle', 'rear-door-handle-and-door-lock', 'rear-door-hood', 'rear-door1'],
            'rear-lamp' => ['rear-lamp-parts'],
        ...
        'maxus-e-deliver-3' => [
            ...
            'body-lower-structure' => ['body-lower-stucture'],
            'body-upper-exterior-trim' => ['body-exterior-trim', 'exterior-emblem-decal-nameplate'],
            'body-upper-structure' => ['baffle-plate-ware', 'inner-framing', 'outer-framing', 'rear-framing', 'roof-framing'],
            'body-window' => ['side-windows', 'window'],
            'brakes' => ['brake-apply', 'brake-apply-plumbing', 'brake-modulator', 'brake-pedal', 'brake-pipes', 'brake-pipes-abs', 'brake-pipes-esp', 'brake-plumbing', 'front-brakes', 'mechanical-parking-brakes', 'park-brake', 'rear-brake-corner', 'rear-brakes', 'rear-disc-brake-corner', 'rear-electric-parking-brakes', 'rear-mechanical-brakes'],
            'bumpersfascia-grille' => ['front-bumper', 'grille', 'rear-bumper', 'wheelhouse-liner'],
            'charging-energystorage' => ['battery-electrical-energy-storage', 'moudule-electric-vehicle-control-unit', 'moudule-electric-vehicle-control-unit-evcc', 'power-battery-asm', 'the-internal-parts-of-power-battery'],
            'chassis-structure' => ['frame', 'front-sub-frame', 'spare-tire-device'],
            'communicate' => ['vehicle-tele-communication'],
            'customer-switches' => ['accessory-switch', 'door-switches', 'ignition-switch-and-key', 'ignition-switchand-key', 'multi-function-column-switch', 'passive-entry-passive-start', 'window-lift-switch'],
            'driver-information' => ['auxiliary-information-electronics', 'clusters', 'vehicle-date-recorder'],
            'emission-exhaust-system' => ['emission-exhaust-system-euro-vi', 'exhaust-system', 'exhaust-system-d20', 'exhaust-system-gasoline-engine'],
            'entertainment' => ['infotainment-system', 'player', 'speaker'],
            'front-closures-front-end-sheetmetal' => ['fenders', 'hood', 'hood-lock'],
            'front-lamp' => ['front-lamp-parts'],
            'frontexterior-hvac-airflow' => ['front-end-exterior-airflow'],
            'frontinterior-hvac-airflow' => ['front-interior-control', 'front-interior-hvac-airflow', 'front-interior-hvacairflow', 'front-interior-hvacairflow-left-rudder'],
            'fuel-storage-handling' => ['coarse-filter-hardware-cuba', 'fuel-plumbing-hardware', 'fuel-plumbing-hardware-d20', 'fuel-tank-canister', 'urea-system', 'urea-system-d20', 'urea-system-euro-vi'],
            'hvac-powertrain-coolingin' => ['air-conditioning-compressor', 'coolant-plumbing-hardware', 'coolant-plumbing-hardware-ev', 'coolant-plumbing-hardware-fcv', 'coolant-plumbing-hardware-phev', 'refrigerant-plumbing-hardware', 'refrigerant-plumbing-hardware-electric-vehicle', 'refrigerant-plumbing-hardware-fcv', 'transmission-oil-cooler-plumbing-hardware'],
            'instrument-panel-console' => ['floor-console', 'floor-console1', 'instrument-panel', 'instrument-panel-crossmember', 'instrument-panel-crossmember-lhd', 'instrument-panel-crossmember-rhd', 'instrument-panel-lhd', 'instrument-panel-rhd', 'instrument-panel1'],
            'interior-acoustic-syetem' => ['sound-insulation、heat-insulation'],
            'interior-lamp' => ['interior-lamp1'],
            'interior-trim' => ['body-lower-structure-garnish-trim', 'body-structure-garnish-trim', 'body-upper-structure-garnish-trim', 'door-trim', 'floor-trim', 'front-door-trim', 'front-side-closure-garnish-trim', 'rear-door-trim', 'rear-doortrim', 'roof-trim', 'side-closure-garnish-trim', 'side-sliding-door-trim', 'side-sliding-doortrim', 'side-trim'],
            'mounts' => ['ept-mounts', 'frame-to-body-mounts', 'power-assembly-installation', 'powertrain-mounts', 'powertrain-mounts-5mt', 'powertrain-mounts-6mt-6amt-9at', 'powertrain-mounts-6mt-amt', 'powertrain-mounts-electric-vehicle'],
            'on-vehicle-attachments-tools' => ['fluids-and-lubrications', 'fluidsand-lubrications', 'lubricant', 'on-vehicle-attachments', 'on-vehicle-tools'],
            'power-energy-storage-link-wire' => ['battery-and-electric-drive-system', 'electric-drive-system', 'electric-drive-system1', 'ept-system', 'ept-system2', 'ept-system3', 'the-internal-parts-of-reduction'],
            'power-generation' => ['accessory-accessory-drive', 'accessory-accessory-drive-d20', 'accessoryaccessory-drive-euro', 'accessoryaccessory-drive-euro-5', 'block-group', 'coolant-pump-and-inl-otlt-tube-d20', 'coolant-pump-and-inl-otlt-tube-thermostat', 'crankshaft-rod', 'crankshaft-rod-d20', 'cylinder-block-accessory', 'cylinder-block-accessory-d20', 'cylinder-blockcylinder-linerflywheel', 'cylinder-head', 'cylinder-head-d20', 'damper-pulley-gear-drive', 'egr-asm', 'egr-asm-d20', 'egr-asm-euro-5', 'engine-accessory', 'engine-accessory-d20', 'engine-accessory-euro-5', 'engine-asm', 'engine-shield', 'engine-wiring-harness', 'exhaust-elbow-turbocharger', 'exhaust-elbow-turbocharger-d20', 'exhaust-elbowturbocharger-euro-5', 'fuel-system', 'head-cover-pcv', 'head-cover-pcv-d20', 'head-coverpcv', 'lp-egr-intake-pipe-accessory', 'manifold-asm-int', 'manifold-asm-int-d20', 'oil-cooler-and-inl-otlt-tube-filter', 'oil-cooler-and-inl-otlt-tube-filter-d20', 'oil-pumps-vacuum-pumps-vacuum-tube-components-d20', 'sensor-harness', 'sensor-harness-d20', 'sensorharness-euro', 'sensorharness-euro-5', 'shaft-balancer', 'shaft-balancer-d20', 'sump-oil-suction-pipe-dipstick', 'sump-oil-suction-pipe-dipstick-d20', 'sumpoil-suction-pipedipstickbalancer-euro-5', 'timing-drive', 'timing-drive-d20', 'uel-system-d20'],
            'power-signaldistribution' => ['battery-cable', 'battery-harness', 'battery-harnesses', 'body-harness', 'chassis-harness', 'chassis-harnesses', 'door-harness', 'engine-compartment-fuse-box', 'engine-compartment-harness', 'high-voltage-harness', 'high-voltage-harness-ev-phev', 'instrument-panel-harness', 'power-outlet-cigarette-lighter-application', 'power-outlet-cigarette-lighter-device'],
            'power-transmission' => ['clutch-housing-6mt-6amt', 'clutch-mt', 'clutch-phev', 'differential-sagw-6amt-6mt', 'front-drive-axle', 'front-half-shaft', 'hybrid-transmission-assembly', 'manual-transmission-assembly', 'manual-transmission-assembly-6mt-front-back-drive', 'propeller-shaft', 'propshaft', 'rear-axle-asm-brk', 'rear-axle-front-drive-vehicle', 'rear-drive-axle', 'rear-drive-axle-yue-jin', 'rear-electric-drive-axle', 'transfer-case-part-time-4wd', 'transmission-accessory-5mt', 'transmission-accessory-6mt-front-drive', 'transmission-accessory-phev', 'transmission-accessory-sagw-6amt', 'transmission-assembly-6at', 'transmission-assembly-8at', 'transmission-assembly-sagw-6mt', 'transmission-body-sagw-6mt-6amt', 'transmission-csc-and-operating-mechanism-6mt-back-drive', 'transmission-differential-6mt-front-drive-6amt', 'transmission-fork-components-sagw-6mt-back-drive', 'transmission-main-shaft-and-gear-6mt-back-drive', 'transmission-operating-mechanism-6amt', 'transmission-seal-6mt-front-drive', 'transmission-shaft-input-6mt-front-drive', 'transmission-shaft-input-6mt-front-drive-6amt', 'transmission-shaft-input-sagw-6mt-6amt', 'transmission-shaft-output-1256-6mt-front-drive', 'transmission-shaft-output-1256-6mt-front-drive-6amt', 'transmission-shaft-output-1256-sagw-6mt-6amt', 'transmission-shaft-output-34r-6mt-front-drive', 'transmission-shaft-output-34r-6mt-front-drive-6amt', 'transmission-shaft-output-34r-sagw-6mt-6amt', 'transmission-shell-6mt-6amt', 'transmission-shell-6mt-front-drive', 'transmission-shell-bearing-6mt-front-drive', 'transmission-shell-bearing-6mt-front-drive-6amt', 'transmission-shift-forks-sagw-6amt-6mt', 'transmissionassembly-and-accessory-sagw-6mt'],
            'powertrain-control-diagnostic' => ['engine-management'],
            'powertrain-driver-interface' => ['accelerator-pedal', 'clutch-apply', 'clutch-apply-5mt', 'clutch-apply-5mt1', 'clutch-apply-6mt', 'transmission-shift-actuation', 'transmission-shift-actuation-mt'],
            'rear-closure' => ['e-gate-handle-and-lock', 'endgate', 'rear-door', 'rear-door-handle-and-door-lock', 'rear-door-hood', 'rear-door1'],
            'rear-lamp' => ['rear-lamp-parts'],
            'rear-view-mirror' => ['rear-view-mirror-parts'],
            'rearinterior-hvac-airflow' => ['interior-heating-pipe', 'rear-interior-airflow'],
            'safety-avoidance' => ['air-bag-control-unit', 'park-distance-control', 'park-distance-control-system'],
            'safety-belt' => ['merchandise-tether-treatment', 'seat-belts', 'side-panel-roof-safety-belt'],
            'sealant-body-attachment' => ['body-attachment'],
            'seats' => ['2014-schoolbus-seat', 'frong-seat-right', 'front-seat-left', 'front-seat-right', 'rear-roll-double-seat', 'rr-sin-seat-w-recl'],
            'side-closures' => ['elec-swinging-dr', 'front-door-electric-glass-regulator', 'front-door-handle-and-lock', 'front-door-handleand-lock', 'front-side-closure', 'rear-side-closure', 'side-sliding-door', 'side-sliding-door-handle', 'side-sliding-door-handle-and-door-lock', 'side-sliding-door-handle-and-door-lock1', 'side-sliding-door-lock', 'side-sliding-door1', 'tnk-fil-dr'],
            'steering' => ['electirc-redirector-left-right-hand', 'redirector', 'redirector-left-hand', 'redirector-left-hand-right-hand', 'redirector-right-hand', 'steering-column'],
            'suspension' => ['five-bar-linkage-spiral-spring-rear-suspension', 'front-shock-absorber', 'front-suspension', 'rear-leaf-spring-suspension', 'rear-shock-absorber', 'rear-suspension'],
            'tirewheelswheel-trim' => ['tirewheeltrim'],
            'wiper-washer' => ['front-washer', 'front-wiper', 'washer', 'washer-system', 'wiper', 'wiper-lhd', 'wiper-rhd'],
        ...
        'maxus-e-deliver-7' => [
            ...
            'body-lower-structure' => ['body-lower-stucture'],
            'body-upper-exterior-trim' => ['body-exterior-trim', 'exterior-emblem-decal-nameplate'],
            'body-upper-structure' => ['inner-framing-left-side', 'inner-framing-right-side', 'outer-framing-left-side', 'outer-framing-right-side', 'roof-framing'],
            'body-window' => ['window'],
            'brakes' => ['brake-apply', 'brake-apply-plumbing', 'brake-modulator', 'brake-pedal', 'brake-pedals', 'brake-pedals1', 'brake-pipes', 'brake-pipes-abs', 'brake-pipes-esp', 'brake-plumbing', 'front-brake-corner', 'front-brakes', 'mechanical-parking-brakes', 'park-brake', 'park-brake-left-hand', 'park-brake-right-hand', 'rear-brakes', 'rear-electric-parking-brakes', 'rear-mechanical-brakes'],
            'bumpersfascia-grille' => ['front-bumper', 'grille', 'rear-bumper', 'wheelhouse-liner'],
            'charging-energystorage' => ['base-module-battery-77kwh-88-8kwh', 'battery-electrical-energy-storage', 'moudule-electric-vehicle-control-unit', 'moudule-electric-vehicle-control-unit-evcc', 'power-battery-asm', 'power-battery-ev', 'the-internal-parts-of-power-battery', 'the-internal-parts-of-power-battery-51-5kwh', 'the-internal-parts-of-power-battery-77kwh-88-8kwh'],
            'chassis-structure' => ['front-sub-frame', 'spare-tire-device'],
            'communicate' => ['vehicle-tele-communication'],
            'customer-switches' => ['accessory-switch', 'accessory-switches', 'door-switches', 'ignition-switch-and-key', 'multi-function-column-switch', 'passive-entry-passive-start', 'window-lift-switch'],
            'driver-information' => ['auxiliary-information-electronics', 'clusters', 'clusters1', 'vehicle-date-recorder'],
            'emission-exhaust-system' => ['exhaust-system-d20'],
            'entertainment' => ['infotainment-system', 'player', 'speaker'],
            'front-closures-front-end-sheetmetal' => ['fenders', 'hood', 'hood-lock'],
            'front-lamp' => ['front-lamp-parts'],
            'frontexterior-hvac-airflow' => ['front-end-exterior-airflow'],
            'frontinterior-hvac-airflow' => ['front-interior-control', 'front-interior-hvac-airflow', 'front-interior-hvacairflow'],
            'fuel-storage-handling' => ['fuel-plumbing-hardware', 'fuel-tank-canister'],
            'hvac-powertrain-coolingin' => ['air-conditioning-compressor', 'coolant-plumbing-hardware', 'coolant-plumbing-hardware-ev', 'coolant-plumbing-hardware-fcv', 'coolant-plumbing-hardware-phev', 'refrigerant-plumbing-hardware', 'refrigerant-plumbing-hardware-electric-vehicle', 'refrigerant-plumbing-hardware-fcv', 'refrigerant-plumbing-hardware-phev', 'transmission-oil-cooler-plumbing-hardware'],
            'instrument-panel-console' => ['floor-console', 'floor-console1', 'instrument-panel', 'instrument-panel-crossmember', 'instrument-panel-crossmember-lhd', 'instrument-panel-crossmember-rhd', 'instrument-panel-lhd', 'instrument-panel-rhd', 'steering-wheel'],
            'interior-acoustic-syetem' => ['sound-insulation、heat-insulation'],
            'interior-lamp' => ['interior-lamp1'],
            ...
            'mounts' => ['ept-mounts', 'frame-to-body-mounts', 'power-assembly-installation', 'powertrain-mounts', 'powertrain-mounts-5mt', 'powertrain-mounts-6mt-6amt-9at', 'powertrain-mounts-6mt-amt', 'powertrain-mounts-electric-vehicle'],
            'on-vehicle-attachments-tools' => ['fluids-and-lubrications', 'fluidsand-lubrications', 'lubricant', 'on-vehicle-attachments', 'on-vehicle-tools'],
            'power-energy-storage-link-wire' => ['battery-and-electric-drive-system', 'electric-drive-system', 'electric-drive-system1', 'ept-system', 'motor-controller-and-accessories'],
            'power-generation' => ['accessory-accessory-drive', 'accessoryaccessory-drive-euro', 'coolant-pump-and-inl-otlt-tube-d20', 'coolant-pump-and-inl-otlt-tube-thermostat', 'crankshaft-rod', 'crankshaft-rod-d20', 'cylinder-block-accessory', 'egr-asm', 'egr-asm-d20', 'engine-accessory-d20', 'engine-accessory-euro-5', 'head-cover-pcv', 'manifold-asm-int', 'manifold-asm-int-d20', 'oil-cooler-and-inl-otlt-tube-filter', 'oil-cooler-and-inl-otlt-tube-filter-d20', 'oil-pumps-vacuum-pumps-vacuum-tube-components-d20', 'sensor-harness', 'sensor-harness-d20', 'sensorharness-euro', 'sensorharness-euro-5', 'sump-oil-suction-pipe-dipstick', 'sump-oil-suction-pipe-dipstick-d20', 'timing-drive', 'timing-drive-d20', 'uel-system-d20'],
            'power-signaldistribution' => ['battery-cable', 'battery-harness', 'battery-harnesses', 'body-accessories-harness', 'chassis-harness', 'door-harness', 'engine-compartment-fuse-box', 'engine-compartment-harness', 'fusebox-cabin-compartment', 'fusebox-engine-compartment', 'high-voltage-harness', 'high-voltage-harness-ev-phev', 'high-voltage-harness-fcv', 'instrument-panel-harness', 'instrument-panel-harness1', 'power-outlet-cigarette-lighter-application', 'power-outlet-cigarette-lighter-hevice'],
            'power-transmission' => ['front-drive-axle', 'front-half-shafts', 'manual-transmission-assembly', 'manual-transmission-assembly-6mt-front-back-drive', 'propeller-shaft', 'propshaft', 'rear-axle-front-drive-vehicle', 'rear-drive-axle', 'rear-drive-axle-yue-jin', 'rear-driven-axle', 'rear-electric-drive-axle', 'transmission-accessory-6mt-front-drive', 'transmission-assembly-6at', 'transmission-csc-and-operating-mechanism-6mt-back-drive', 'transmission-operating-mechanism-6mt-front-drive'],
            'powertrain-control-diagnostic' => ['engine-management'],
            'powertrain-driver-interface' => ['accelerator-pedal', 'clutch-apply', 'clutch-apply-5mt', 'clutch-apply-5mt1', 'clutch-apply-6mt', 'transmission-operating-mechanism-6mt', 'transmission-operating-mechanism-6mt-e5', 'transmission-shift-actuation', 'transmission-shift-actuation-6amt', 'transmission-shift-actuation-6amt-9at', 'transmission-shift-actuation-amt', 'transmission-shift-actuation-at、electric-vehicle', 'transmission-shift-actuation-mt', 'transmission-shift-actuation-mt-5mt', 'transmission-shift-actuation-mt-5mt1', 'transmission-shift-actuation-mt-6mt'],
            'rear-closure' => ['endgate', 'rear-door', 'rear-door-check', 'rear-door-handle', 'rear-door-handle-and-door-lock', 'rear-door-hood', 'rear-door1'],
            'rear-lamp' => ['rear-lamp-parts'],
            'rear-view-mirror' => ['rear-view-mirror-parts'],
            'rearinterior-hvac-airflow' => ['rear-interior-airflow'],
            'safety-avoidance' => ['air-bag-control-unit', 'park-distance-control-system'],
            'safety-belt' => ['merchandise-tether-treatment', 'safety-belts', 'side-panel-roof-safety-belt'],
            'sealant-body-attachment' => ['body-attachment'],
            'seats' => ['frong-seat-right', 'front-double-seats', 'front-electirc-seat-left', 'front-electirc-seat-right', 'front-electrical-seat-lh', 'front-manual-seat-left', 'front-manual-seat-lh', 'front-manual-seat-rh', 'front-manual-seat-right', 'front-seat-left', 'front-seat-right', 'rear-roll-double-seat', 'rear-row-seat', 'seats-layout', 'second-row-three-seat-two-head-rest-three-head-rest', 'subdrivers-integral-double-seat', 'subdrivers-split-double-seat', 'subdrivers-split-double-seat1'],
            'side-closures' => ['front-door-electric-glass-regulator', 'front-door-handle-and-lock', 'front-door-handleand-lock', 'front-side-closure', 'rear-side-closure', 'side-sliding-door', 'side-sliding-door-guide-rail', 'side-sliding-door-handle', 'side-sliding-door-handle-and-door-lock', 'side-sliding-door-handle-and-door-lock1', 'side-sliding-door-lock', 'side-sliding-door1', 'tnk-fil-dr'],
            'steering' => ['electirc-redirector-left-right-hand', 'power-steering-plumbing-pipe', 'redirector', 'redirector-left-hand', 'redirector-left-hand-right-hand', 'redirector-right-hand', 'steering-column'],
            'suspension' => ['five-bar-linkage-spiral-spring-rear-suspension', 'front-shock-absorber', 'front-suspension', 'rear-leaf-spring-suspension', 'rear-shock-absorber', 'rear-suspension'],
            'tirewheelswheel-trim' => ['tirewheeltrim'],
            'wiper-washer' => ['front-washer', 'front-wiper', 'washer-system', 'wiper', 'wiper-lhd', 'wiper-rhd'],
        ],
        'maxus-e-deliver-9' => [
            ...
            'brakes' => ['brake-apply', 'brake-apply-plumbing', 'brake-modulator', 'brake-pedal', 'brake-pedals', 'brake-pedals1', 'brake-pipes', 'brake-pipes-abs', 'brake-pipes-esp', 'brake-plumbing', 'front-brake-corner', 'front-brakes', 'mechanical-parking-brakes', 'park-brake', 'rear-brakes', 'rear-mechanical-brakes'],
            'bumpersfascia-grille' => ['front-bumper', 'grille', 'rear-bumper', 'wheelhouse-liner'],
            'charging-energystorage' => ['battery-electrical-energy-storage', 'inside-the-power-battery-catl-88-55kwh', 'moudule-electric-vehicle-control-unit', 'the-internal-parts-of-power-battery', 'the-internal-parts-of-power-battery-catl-88-55kwh'],
            'chassis-structure' => ['frame', 'front-sub-frame', 'spare-tire-device'],
            'communicate' => ['vehicle-tele-communication'],
            'customer-switches' => ['accessory-switch', 'accessory-switches', 'door-switches', 'ignition-switch-and-key', 'multi-function-column-switch', 'passive-entry-passive-start', 'window-lift-switch'],
            'driver-information' => ['auxiliary-information-electronics', 'clusters', 'vehicle-date-recorder'],
            'emission-exhaust-system' => ['exhaust-system'],
            'entertainment' => ['infotainment-system', 'player', 'speaker'],
            'front-closures-front-end-sheetmetal' => ['fenders', 'hood', 'hood-lock'],
            'front-lamp' => ['front-lamp-parts'],
            'frontexterior-hvac-airflow' => ['front-end-exterior-airflow'],
            ...
            'mounts' => ['ept-mounts', 'power-assembly-installation', 'powertrain-mounts-5mt', 'powertrain-mounts-6mt-6amt-9at', 'powertrain-mounts-6mt-amt', 'powertrain-mounts-electric-vehicle'],
            'on-vehicle-attachments-tools' => ['fluids-and-lubrications', 'fluidsand-lubrications', 'lubricant', 'on-vehicle-attachments', 'on-vehicle-tools'],
            'power-energy-storage-link-wire' => ['battery-and-electric-drive-system', 'ept-system', 'motor-controller-and-accessories', 'the-internal-parts-of-reduction'],
            'power-generation' => ['accessory-accessory-drive', 'accessoryaccessory-drive-euro', 'egr-asm', 'egr-asm-d20', 'engine-accessory', 'engine-accessory-euro-5', 'engine-shield', 'sensor-harness', 'sensor-harness-d20', 'sensorharness-euro', 'sensorharness-euro-5'],
            'power-signaldistribution' => ['battery-cable', 'battery-harness', 'battery-harnesses', 'body-accessories-harness', 'chassis-harnesses', 'door-wire-harnesses', 'engine-compartment-fuse-box', 'engine-compartment-harness', 'fusebox-engine-compartment', 'high-voltage-harness', 'high-voltage-harness-ev-phev', 'instrument-panel-harness', 'instrument-panel-harness1', 'power-outlet-cigarette-lighter-application', 'power-outlet-cigarette-lighter-hevice'],
            'power-transmission' => ['propshaft', 'rear-axle-front-drive-vehicle', 'rear-drive-axle', 'rear-drive-axle-yue-jin', 'rear-driven-axle', 'rear-electric-drive-axle', 'transfer-case-part-time-4wd', 'transmission-accessory-phev'],
            'powertrain-control-diagnostic' => ['engine-management'],
            'powertrain-driver-interface' => ['accelerator-pedal', 'clutch-apply', 'clutch-apply-5mt', 'clutch-apply-5mt1', 'clutch-apply-6mt', 'transmission-operating-mechanism-6mt', 'transmission-operating-mechanism-6mt-e5', 'transmission-shift-actuation', 'transmission-shift-actuation-6amt', 'transmission-shift-actuation-6amt-9at', 'transmission-shift-actuation-amt', 'transmission-shift-actuation-at、electric-vehicle', 'transmission-shift-actuation-mt', 'transmission-shift-actuation-mt-5mt', 'transmission-shift-actuation-mt-5mt1', 'transmission-shift-actuation-mt-6mt'],
            'rear-closure' => ['endgate', 'rear-door', 'rear-door-handle', 'rear-door-handle-and-door-lock', 'rear-door-hood', 'rear-door1'],
            'rear-lamp' => ['rear-lamp-parts'],
            'rear-view-mirror' => ['rear-view-mirror-parts'],
            'rearinterior-hvac-airflow' => ['rear-interior-airflow'],
            'safety-avoidance' => ['air-bag-control-unit', 'park-distance-control', 'park-distance-control-system'],
            'safety-belt' => ['merchandise-tether-treatment', 'side-panel-roof-safety-belt'],
            'sealant-body-attachment' => ['body-attachment'],
            'seats' => ['2014-schoolbus-seat', 'arrangement-for-van-vehicle-uk、hong-kong', 'frong-seat-right', 'front-double-seats', 'front-manual-seat-left', 'front-manual-seat-right', 'front-seat-left', 'front-seat-right', 'seat-arrangement-of-shang-jies-11-12and-14-seats-australia', 'subdrivers-integral-double-seat', 'subdrivers-split-double-seat', 'three-seats-arrangement-for-chassis-vehicle-uk、hong-kong', 'three-seats-arrangement-for-van-vehicle-australia、new-zealand', 'two-three-seats-arrangement-for-chassis-vehicle-australia、new-zealand'],
            'side-closures' => ['elec-swinging-dr', 'front-door-electric-glass-regulator', 'front-door-handle-and-lock', 'front-door-handleand-lock', 'front-side-closure', 'rear-side-closure', 'side-sliding-door', 'side-sliding-door-guide-rail', 'side-sliding-door-handle-and-door-lock', 'side-sliding-door-handle-and-door-lock1', 'side-sliding-door-lock', 'side-sliding-door1', 'tnk-fil-dr'],
            'steering' => ['electirc-redirector-left-right-hand', 'redirector', 'redirector-left-hand', 'redirector-right-hand', 'steering-column'],
            'suspension' => ['five-bar-linkage-spiral-spring-rear-suspension', 'front-shock-absorber', 'front-suspension', 'rear-shock-absorber', 'rear-suspension'],
            'tirewheelswheel-trim' => ['tirewheeltrim'],
            'wiper-washer' => ['front-wiper', 'washer-system', 'wiper', 'wiper-lhd', 'wiper-rhd'],
        ],
        'maxus-t60' => [
            ...
            'body-upper-structure' => ['baffle-plate-ware', 'inner-framing', 'outer-framing', 'rear-framing', 'roof-framing'],
            'body-window' => ['window'],
            'brakes' => ['brake-apply', 'brake-apply-plumbing', 'brake-modulator', 'brake-pedal', 'brake-pipes', 'brake-pipes-abs', 'brake-pipes-esp', 'brake-plumbing', 'front-brake-corner', 'front-brakes', 'mechanical-parking-brakes', 'park-brake', 'rear-brake-corner', 'rear-brakes', 'rear-electric-parking-brakes', 'rear-mechanical-brakes'],
            'bumpersfascia-grille' => ['front-bumper', 'grille', 'rear-bumper', 'wheelhouse-liner'],
            'charging-energystorage' => ['battery-electrical-energy-storage', 'moudule-electric-vehicle-control-unit', 'power-battery-asm', 'power-battery-ev', 'the-internal-parts-of-power-battery', 'the-internal-parts-of-power-battery-77kwh-88-8kwh'],
            'chassis-structure' => ['frame', 'spare-tire-device'],
            'communicate' => ['vehicle-tele-communication'],
            'customer-switches' => ['accessory-switch', 'accessory-switches', 'door-switches', 'ignition-switch-and-key', 'multi-function-column-switch', 'passive-entry-passive-start', 'window-lift-switch'],
            'driver-information' => ['auxiliary-information-electronics', 'clusters'],
            'emission-exhaust-system' => ['emission-exhaust-system-euro-vi', 'exhaust-system', 'exhaust-system-d20', 'exhaust-system-gasoline-engine'],
            'entertainment' => ['infotainment-system', 'player', 'speaker'],
            'front-closures-front-end-sheetmetal' => ['fenders', 'hood', 'hood-lock'],
            'front-lamp' => ['front-lamp-parts'],
            ...
            'frontinterior-hvac-airflow' => ['front-interior-control', 'front-interior-hvac-airflow', 'front-interior-hvacairflow', 'front-interior-hvacairflow-left-rudder', 'front-interior-hvacairflow-right-rudder'],
            'fuel-storage-handling' => ['coarse-filter-hardware-cuba', 'fuel-plumbing-hardware', 'fuel-plumbing-hardware-d20', 'fuel-tank-canister', 'urea-system', 'urea-system-d20', 'urea-system-euro-vi'],
            'hvac-powertrain-coolingin' => ['air-conditioning-compressor', 'coolant-plumbing-hardware', 'coolant-plumbing-hardware-phev', 'refrigerant-plumbing-hardware', 'refrigerant-plumbing-hardware-electric-vehicle', 'refrigerant-plumbing-hardware-phev', 'transmission-oil-cooler-plumbing-hardware'],
            'instrument-panel-console' => ['floor-console', 'floor-console1', 'instrument-panel', 'instrument-panel-crossmember', 'instrument-panel-lhd', 'steering-wheel'],
            'interior-acoustic-syetem' => ['sound-insulation、heat-insulation'],
            'interior-lamp' => ['interior-lamp1'],
            'interior-trim' => ['body-lower-structure-garnish-trim', 'body-structure-garnish-trim', 'body-upper-structure-garnish-trim', 'door-trim', 'floor-trim', 'front-door-trim', 'front-side-closure-garnish-trim', 'rear-door-trim', 'rear-doortrim', 'roof-trim', 'side-closure-garnish-trim', 'side-sliding-door-trim', 'side-sliding-doortrim', 'side-trim'],
            'mounts' => ['ept-mounts', 'frame-to-body-mounts', 'power-assembly-installation', 'powertrain-mounts', 'powertrain-mounts-5mt', 'powertrain-mounts-6mt-6amt-9at', 'powertrain-mounts-6mt-amt'],
            'on-vehicle-attachments-tools' => ['fluids-and-lubrications', 'fluidsand-lubrications', 'lubricant', 'on-vehicle-attachments', 'on-vehicle-tools'],
            'pickup-box' => ['cargo-car-body-assembly', 'front-panel-assembly', 'platform-assembly', 'side-panel-inner-assembly', 'side-panel-outer-assembly'],
            'power-energy-storage-link-wire' => ['battery-and-electric-drive-system', 'electric-drive-system', 'ept-system', 'motor-controller-and-accessories'],
            'power-generation' => ['accessory-accessory-drive', 'accessory-accessory-drive-d20', 'accessoryaccessory-drive-euro-5', 'coolant-pump-and-inl-otlt-tube-d20', 'coolant-pump-and-inl-otlt-tube-thermostat', 'crankshaft-rod', 'crankshaft-rod-d20', 'cylinder-block-accessory', 'cylinder-block-accessory-d20', 'cylinder-blockcylinder-linerflywheel', 'cylinder-head', 'cylinder-head-d20', 'damper-pulley-gear-drive', 'egr-asm', 'egr-asm-d20', 'egr-asm-euro-5', 'engine-accessory', 'engine-accessory-d20', 'engine-accessory-euro-5', 'engine-asm-d20', 'engine-asm-d20-stp', 'engine-shield', 'exhaust-elbow-turbocharger', 'exhaust-elbow-turbocharger-d20', 'exhaust-elbowturbocharger-euro-5', 'fuel-system', 'head-cover-pcv', 'head-cover-pcv-d20', 'lp-egr-intake-pipe-accessory', 'manifold-asm-int', 'manifold-asm-int-d20', 'oil-cooler-and-inl-otlt-tube-filter', 'oil-cooler-and-inl-otlt-tube-filter-d20', 'oil-pumps-vacuum-pumps-vacuum-tube-components-d20', 'sensor-harness', 'sensor-harness-d20', 'sensorharness-euro', 'sensorharness-euro-5', 'shaft-balancer', 'shaft-balancer-d20', 'sump-oil-suction-pipe-dipstick', 'sump-oil-suction-pipe-dipstick-d20', 'sumpoil-suction-pipedipstickbalancer-euro-5', 'timing-drive', 'timing-drive-d20', 'uel-system-d20'],
            'power-signaldistribution' => ['battery-cable', 'battery-harnesses', 'body-harness', 'chassis-harness', 'chassis-harnesses', 'door-harness', 'engine-compartment-fuse-box', 'engine-compartment-harness', 'fusebox-cabin-compartment', 'fusebox-engine-compartment', 'high-voltage-harness', 'high-voltage-harness-ev-phev', 'high-voltage-harness-fcv', 'instrument-panel-harness', 'instrument-panel-harness1', 'instrument-panel-wire-harnesses', 'power-outlet-cigarette-lighter-application', 'power-outlet-cigarette-lighter-device', 'power-outlet-cigarette-lighter-hevice'],
            'power-transmission' => ['breather-tube-kit', 'converter-kit', 'converter-sealing-elements-kit', 'front-drive-axle', 'manual-transmission-assembly', 'mechatronic-kit', 'mechatronic-sealing-elements-replacement', 'oil-pan-kit', 'propeller-shaft', 'propshaft', 'rear-axle-asm-brk', 'rear-axle-front-drive-vehicle', 'rear-drive-axle', 'rear-drive-axle-yue-jin', 'rear-driven-axle', 'selector-shaft-sealing-ring-kit', 'shaft-sealing-ring-output', 'transfer-case-part-time-4wd', 'transfer-case-torque-on-demand', 'transmission-accessory-5mt', 'transmission-assembly-6at', 'transmission-assembly-8at'],
            'powertrain-control-diagnostic' => ['engine-management'],
            'powertrain-driver-interface' => ['accelerator-pedal', 'clutch-apply', 'clutch-apply-5mt', 'clutch-apply-5mt1', 'clutch-apply-6mt'],
            'rear-closure' => ['e-gate-handle-and-lock', 'endgate', 'rear-door', 'rear-door-handle-and-door-lock', 'rear-door-hood', 'rear-door1'],
            'rear-lamp' => ['rear-lamp-parts'],
            'rear-view-mirror' => ['rear-view-mirror-parts'],
            'rearinterior-hvac-airflow' => ['interior-heating-pipe', 'interior-heating-pipe-front', 'interior-heating-pipe-rear', 'rear-interior-airflow'],
            'safety-avoidance' => ['air-bag-control-unit', 'park-distance-control-system'],
            'safety-belt' => ['safety-belt-driver、copilot', 'safety-belts', 'second-row-seat-belts', 'side-panel-roof-safety-belt', 'third-row-safety-belts'],
            'sealant-body-attachment' => ['body-attachment'],
            'seats' => ['frong-seat-right', 'front-electirc-seat-left', 'front-electirc-seat-right', 'front-electrical-seat-lh', 'front-electrical-seat-rh', 'front-manual-seat-lh', 'front-manual-seat-rh', 'front-seat-left', 'front-seat-right', 'frt-dbl-seat', 'rear-row-seat', 'seats-layout', 'second-row-double-seat', 'second-row-three-seat-two-head-rest-three-head-rest'],
            'side-closures' => ['elec-swinging-dr', 'front-door-electric-glass-regulator', 'front-door-handle-and-lock', 'front-door-handleand-lock', 'front-side-closure', 'rear-side-closure', 'side-sliding-door', 'side-sliding-door-handle', 'side-sliding-door-handle-and-door-lock', 'side-sliding-door-handle-and-door-lock1', 'side-sliding-door-lock', 'tnk-fil-dr'],
            'steering' => ['electirc-redirector-left-right-hand', 'power-steering-plumbing-pipe1', 'redirector', 'redirector-left-hand', 'redirector-left-hand-right-hand', 'redirector-right-hand', 'steering-column'],
            'suspension' => ['five-bar-linkage-spiral-spring-rear-suspension', 'front-shock-absorber', 'front-suspension', 'rear-leaf-spring-suspension', 'rear-shock-absorber', 'rear-suspension'],
            'tirewheelswheel-trim' => ['tirewheeltrim'],
            'wiper-washer' => ['front-washer', 'front-wiper', 'washer-system', 'wiper', 'wiper-lhd', 'wiper-rhd'],
        ],
        'maxus-t90-ev' => [
            ...
            'body-lower-structure' => ['body-lower-stucture'],
            'body-upper-exterior-trim' => ['body-exterior-trim', 'exterior-emblem-decal-nameplate'],
            'body-upper-structure' => ['baffle-plate-ware', 'inner-framing', 'outer-framing', 'roof-framing'],
            'body-window' => ['side-windows', 'window'],
            'brakes' => ['brake-apply', 'brake-apply-plumbing', 'brake-modulator', 'brake-pedal', 'brake-pedals', 'brake-pedals1', 'brake-pipes', 'brake-pipes-abs', 'brake-pipes-esp', 'brake-plumbing', 'front-brake-corner', 'front-brakes', 'mechanical-parking-brakes', 'park-brake', 'park-brake-left-hand', 'park-brake-right-hand', 'rear-brake-corner', 'rear-brakes', 'rear-disc-brake-corner', 'rear-electric-parking-brakes', 'rear-mechanical-brakes'],
            'bumpersfascia-grille' => ['front-bumper', 'grille', 'rear-bumper', 'wheelhouse-liner'],
            'charging-energystorage' => ['battery-electrical-energy-storage', 'inside-the-power-battery-catl-88-55kwh', 'moudule-electric-vehicle-control-unit', 'moudule-electric-vehicle-control-unit-evcc', 'power-battery-asm', 'power-battery-ev', 'power-inverter', 'the-internal-parts-of-power-battery', 'the-internal-parts-of-power-battery-77kwh-88-8kwh', 'the-internal-parts-of-power-battery-catl-88-55kwh'],
            'chassis-structure' => ['frame'],
            'communicate' => ['vehicle-tele-communication'],
            'customer-switches' => ['accessory-switch', 'accessory-switches', 'door-switches', 'ignition-switch-and-key', 'ignition-switchand-key', 'multi-function-column-switch', 'passive-entry-passive-start', 'window-lift-switch'],
            'driver-information' => ['auxiliary-information-electronics', 'clusters', 'schoolbus-electronics'],
            'emission-exhaust-system' => ['emission-exhaust-system-euro-vi', 'exhaust-system', 'exhaust-system-d20', 'exhaust-system-gasoline-engine'],
            'entertainment' => ['infotainment-system', 'player', 'speaker'],
            'front-closures-front-end-sheetmetal' => ['fenders', 'hood', 'hood-lock'],
            'front-lamp' => ['front-lamp-parts'],
            ...
            'mounts' => ['ept-mounts', 'frame-to-body-mounts', 'power-assembly-installation', 'powertrain-mounts', 'powertrain-mounts-5mt', 'powertrain-mounts-6mt-6amt-9at', 'powertrain-mounts-6mt-amt'],
            'on-vehicle-attachments-tools' => ['fluids-and-lubrications', 'fluidsand-lubrications', 'lubricant', 'on-vehicle-attachments', 'on-vehicle-tools'],
            'pickup-box' => ['cargo-car-body-assembly', 'front-panel-assembly', 'platform-assembly', 'side-panel-outer-assembly'],
            'power-energy-storage-link-wire' => ['battery-and-electric-drive-system', 'electric-drive-system', 'electric-drive-system1', 'ept-system', 'ept-system1', 'motor-controller-and-accessories', 'the-internal-parts-of-reduction'],
            'power-generation' => ['accessory-accessory-drive', 'accessory-accessory-drive-d20', 'accessoryaccessory-drive-euro', 'accessoryaccessory-drive-euro-5', 'coolant-pump-and-inl-otlt-tube-d20', 'coolant-pump-and-inl-otlt-tube-thermostat', 'crankshaft-rod', 'crankshaft-rod-d20', 'damper-pulley-gear-drive', 'egr-asm', 'egr-asm-d20', 'engine-accessory', 'engine-accessory-d20', 'engine-accessory-euro-5', 'engine-shield', 'engine-wiring-harness', 'exhaust-elbow-turbocharger', 'exhaust-elbow-turbocharger-d20', 'exhaust-elbowturbocharger-euro-5', 'fuel-system', 'head-cover-pcv', 'head-cover-pcv-d20', 'lp-egr-intake-pipe-accessory', 'manifold-asm-int-d20', 'oil-cooler-and-inl-otlt-tube-filter-d20', 'oil-pumps-vacuum-pumps-vacuum-tube-components-d20', 'sensor-harness', 'sensor-harness-d20', 'sensorharness-euro', 'sensorharness-euro-5', 'sump-oil-suction-pipe-dipstick', 'sump-oil-suction-pipe-dipstick-d20', 'timing-drive', 'timing-drive-d20', 'uel-system-d20'],
            'power-signaldistribution' => ['battery-cable', 'battery-harness', 'battery-harnesses', 'body-harness', 'chassis-harness', 'chassis-harnesses', 'door-harness', 'engine-compartment-fuse-box', 'engine-compartment-harness', 'fusebox-engine-compartment', 'high-voltage-harness', 'high-voltage-harness-ev-phev', 'high-voltage-harness-fcv', 'instrument-panel-harness', 'instrument-panel-harness1', 'instrument-panel-wire-harnesses', 'power-outlet-cigarette-lighter-application', 'power-outlet-cigarette-lighter-hevice'],
            'power-transmission' => ['front-drive-axle', 'propeller-shaft', 'propshaft', 'rear-axle-asm-brk', 'rear-axle-front-drive-vehicle', 'rear-drive-axle', 'rear-drive-axle-yue-jin', 'rear-driven-axle', 'rear-electric-drive-axle', 'transfer-case-part-time-4wd', 'transmission-assembly-6at', 'transmission-assembly-8at'],
            'powertrain-control-diagnostic' => ['engine-management'],
            'powertrain-driver-interface' => ['accelerator-pedal', 'clutch-apply', 'clutch-apply-5mt', 'clutch-apply-5mt1', 'clutch-apply-6mt', 'transmission-operating-mechanism-6mt', 'transmission-operating-mechanism-6mt-e5', 'transmission-shift-actuation', 'transmission-shift-actuation-6amt', 'transmission-shift-actuation-6amt-9at', 'transmission-shift-actuation-amt', 'transmission-shift-actuation-at、electric-vehicle', 'transmission-shift-actuation-mt', 'transmission-shift-actuation-mt-5mt', 'transmission-shift-actuation-mt-5mt1', 'transmission-shift-actuation-mt-6mt'],
            'rear-closure' => ['e-gate-handle-and-lock', 'endgate', 'rear-door', 'rear-door-handle', 'rear-door-handle-and-door-lock', 'rear-door-hood', 'rear-door1'],
            'rear-lamp' => ['rear-lamp-parts'],
            'rear-view-mirror' => ['rear-view-mirror-parts'],
            'rearinterior-hvac-airflow' => ['interior-heating-pipe', 'interior-heating-pipe-fcv', 'interior-heating-pipe-front', 'interior-heating-pipe-rear', 'rear-interior-airflow'],
            'safety-avoidance' => ['air-bag-control-unit', 'park-distance-control', 'park-distance-control-system'],
            'safety-belt' => ['safety-belt-driver、copilot', 'safety-belts', 'second-row-seat-belts', 'side-panel-roof-safety-belt', 'third-row-safety-belts'],
            'sealant-body-attachment' => ['body-attachment'],
            'seats' => ['2014-schoolbus-seat', '2015-school-seat', 'frong-seat-right', 'front-electirc-seat-left', 'front-electirc-seat-right', 'front-electrical-seat-lh', 'front-electrical-seat-rh', 'front-manual-seat-lh', 'front-manual-seat-rh', 'front-seat-left', 'front-seat-right', 'frt-dbl-seat', 'rear-row-seat', 'seats-layout', 'second-row-double-seat', 'second-row-three-seat-two-head-rest-three-head-rest'],
            'side-closures' => ['elec-swinging-dr', 'front-door-electric-glass-regulator', 'front-door-handle-and-lock', 'front-door-handleand-lock', 'front-side-closure', 'rear-side-closure', 'side-sliding-door', 'side-sliding-door-handle', 'side-sliding-door-handle-and-door-lock', 'side-sliding-door-handle-and-door-lock1', 'side-sliding-door-lock', 'side-sliding-door1', 'tnk-fil-dr'],
            'steering' => ['electirc-redirector-left-right-hand', 'power-steering-plumbing-pipe', 'redirector', 'redirector-left-hand', 'redirector-left-hand-right-hand', 'redirector-right-hand', 'steering-column'],
            'suspension' => ['five-bar-linkage-spiral-spring-rear-suspension', 'front-shock-absorber', 'front-suspension', 'rear-leaf-spring-suspension', 'rear-shock-absorber', 'rear-suspension'],
            'tirewheelswheel-trim' => ['tirewheeltrim'],
        ...
        'maxus-v80-van' => [
            ...
            'body-lower-exterior-trim' => ['mud-guard'],
            'body-upper-exterior-trim' => ['body-exterior-trim', 'exterior-emblem-decal-nameplate'],
            'body-upper-structure' => ['inner-framing-left-side', 'inner-framing-right-side', 'outer-framing-left-side', 'outer-framing-right-side', 'panel-asm-body-si-r-end-asm-rr', 'roof-framing'],
            'body-window' => ['front-rear-window', 'side-windows'],
            'brakes' => ['brake-apply', 'brake-apply-plumbing', 'brake-modulator', 'brake-pedal', 'brake-pedals', 'brake-pedals1', 'brake-pipes', 'brake-pipes-abs', 'brake-pipes-esp', 'brake-plumbing', 'front-brake-corner', 'front-brakes', 'mechanical-parking-brakes', 'park-brake', 'park-brake-left-hand', 'park-brake-right-hand', 'rear-brake-corner', 'rear-brakes', 'rear-electric-parking-brakes', 'rear-mechanical-brakes'],
            'bumpersfascia-grille' => ['front-bumper', 'grille', 'rear-bumper', 'wheelhouse-liner'],
            'charging-energystorage' => ['battery-electrical-energy-storage', 'moudule-electric-vehicle-control-unit', 'the-internal-parts-of-power-battery-77kwh-88-8kwh'],
            'chassis-structure' => ['frame', 'front-sub-frame', 'spare-tire-bracket'],
            'communicate' => ['vehicle-tele-communication'],
            'customer-switches' => ['accessory-switch', 'accessory-switches', 'accessory-switches1', 'door-switches', 'ignition-switch-and-key', 'ignition-switchand-key', 'lighting-switch', 'lighting-switch1', 'multi-function-column-switch', 'passive-entry-passive-start', 'window-lift-switch'],
            'driver-information' => ['clusters', 'clusters1', 'schoolbus-electronics', 'vehicle-date-recorder'],
            'emission-exhaust-system' => ['emission-exhaust-system-euro-vi', 'exhaust-system', 'exhaust-system-d20', 'exhaust-system-gasoline-engine'],
            'entertainment' => ['infotainment-system', 'player', 'speaker'],
            'front-closures-front-end-sheetmetal' => ['fenders', 'hood', 'hood-lock'],
            'front-lamp' => ['front-lamp-parts'],
            ...
            'frontinterior-hvac-airflow' => ['front-interior-control', 'front-interior-hvac-airflow', 'front-interior-hvacairflow', 'front-interior-hvacairflow-left-rudder', 'front-interior-hvacairflow-right-rudder'],
            'fuel-storage-handling' => ['coarse-filter-hardware-cuba', 'fuel-plumbing-hardware', 'fuel-plumbing-hardware-d20', 'fuel-tank-canister', 'urea-system', 'urea-system-d20', 'urea-system-euro-vi'],
            'hvac-powertrain-coolingin' => ['coolant-plumbing-hardware', 'refrigerant-plumbing-hardware', 'refrigerant-plumbing-hardware-electric-vehicle', 'refrigerant-plumbing-hardware-fcv', 'refrigerant-plumbing-hardware-phev', 'transmission-oil-cooler-plumbing-hardware'],
            'instrument-panel-console' => ['floor-console', 'floor-console1', 'instrument-panel', 'instrument-panel-crossmember', 'instrument-panel-crossmember1', 'steering-wheel'],
            'interior-acoustic-syetem' => ['sound-insulation、heat-insulation'],
            'interior-lamp' => ['interior-lamp1'],
            'interior-trim' => ['body-lower-structure-garnish-trim', 'body-structure-garnish-trim', 'body-upper-structure-garnish-trim', 'door-trim', 'floor-trim', 'front-door-trim', 'front-side-closure-garnish-trim', 'rear-door-trim', 'rear-doortrim', 'roof-trim', 'side-closure-garnish-trim', 'side-sliding-door-trim', 'side-sliding-doortrim', 'side-trim'],
            'mounts' => ['power-assembly-installation', 'powertrain-mounts', 'powertrain-mounts-5mt', 'powertrain-mounts-6mt-6amt-9at', 'powertrain-mounts-6mt-amt'],
            'on-vehicle-attachments-tools' => ['fluids-and-lubrications', 'fluidsand-lubrications', 'lubricant', 'on-vehicle-attachments', 'on-vehicle-tools'],
            'power-energy-storage-link-wire' => ['ept-system', 'ept-system2', 'ept-system3', 'the-internal-parts-of-reduction'],
            'power-generation' => ['accessoryaccessory-drive-euro', 'accessoryaccessory-drive-euro-5', 'coolant-pump-and-inl-otlt-tubethermostat-euro', 'coolant-pump-and-inl-otlt-tubethermostat-euro-5', 'crankshaft-rod', 'cylinder-block-accessory', 'cylinder-blockcylinder-linerflywheel', 'cylinder-head', 'damper-pulleygear-drive', 'egr-asm', 'egr-asm-d20', 'egr-asm-euro', 'egr-asm-euro-5', 'engine-accessory', 'engine-accessory-d20', 'engine-accessory-euro-5', 'engine-euro-5', 'exhaust-elbowturbocharger-euro', 'exhaust-elbowturbocharger-euro-5', 'fuel-system', 'half-cylinder-block-group-euro-5', 'head-coverpcv', 'intake-and-exhaust-manifold-euro-5', 'intakeand-exhaust-manifold-euro', 'manifold-asm-int', 'manifold-asm-int-d20', 'oil-cooler-and-inl-otlt-tubefilter-euro', 'oil-cooler-and-inl-otlt-tubefilter-euro-5', 'sensor-harness', 'sensor-harness-d20', 'sensorharness-euro', 'sensorharness-euro-5', 'sumpoil-suction-pipedipstickbalancer-euro-5', 'sump，oil-suction-pipedipstickbalancer-euro', 'timing-drive', 'timing-drive-d20'],
            'power-signaldistribution' => ['battery-cable', 'battery-harness', 'body-harness', 'chassis-harness', 'chassis-harnesses', 'door-harness', 'door-harness1', 'door-wire-harnesses', 'engine-compartment-fuse-box', 'engine-compartment-harness', 'engine-compartment-harness1', 'fusebox-cabin-compartment', 'fusebox-engine-compartment', 'ground-distribution', 'high-voltage-harness', 'high-voltage-harness-ev-phev', 'high-voltage-harness-fcv', 'instrument-panel-harness', 'instrument-panel-harness1', 'instrument-panel-wire-harnesses', 'power-outlet-cigarette-lighter-application', 'roof-harness'],
            'power-transmission' => ['clutch-5mt', 'clutch-6mt-6amt', 'clutch-housing-6mt-6amt', 'clutch-housing-6mt-front-drive-6amt', 'differential-sagw-6amt-6mt', 'front-half-shafts', 'propeller-shaft', 'rear-axle-asm-brk', 'rear-axle-front-drive-vehicle', 'rear-drive-axle', 'rear-drive-axle-yue-jin', 'rear-driven-axle', 'transmission-accessory-5mt', 'transmission-accessory-6mt-front-drive', 'transmission-accessory-phev', 'transmission-accessory-sagw-6amt', 'transmission-body-5mt', 'transmission-body-sagw-6mt-6amt', 'transmission-csc-and-operating-mechanism-6mt-back-drive', 'transmission-differential-6mt-front-drive', 'transmission-differential-6mt-front-drive-6amt', 'transmission-fork-6mt-front-drive', 'transmission-fork-6mt-front-drive-6mt', 'transmission-gear-5mt', 'transmission-main-shaft-and-gear-6mt-back-drive', 'transmission-operating-mechanism-6amt', 'transmission-operating-mechanism-6mt-front-drive', 'transmission-operating-mechanism-sagw-6mt', 'transmission-output-shaft-and-gear-wia-6mt', 'transmission-rvs-idler-shaft-gear-6mt-front-drive', 'transmission-rvs-idler-shaft-gear-6mt-front-drive-6amt', 'transmission-rvs-idler-shaft-gear-sagw-6amt-6mt', 'transmission-seal-6mt-front-drive', 'transmission-shaft-asm-sagw-6amt-6mt', 'transmission-shaft-input-sagw-6mt-6amt', 'transmission-shaft-output-1256-6mt-front-drive', 'transmission-shaft-output-1256-6mt-front-drive-6amt', 'transmission-shaft-output-1256-sagw-6mt-6amt', 'transmission-shaft-output-34r-6mt-front-drive', 'transmission-shaft-output-34r-6mt-front-drive-6amt', 'transmission-shaft-output-34r-sagw-6mt-6amt', 'transmission-shell-6mt-6amt', 'transmission-shell-6mt-front-drive', 'transmission-shell-bearing-6mt-front-drive', 'transmission-shell-bearing-6mt-front-drive-6amt', 'transmission-shift-forks-sagw-6amt-6mt', 'transmissionassembly-and-accessory-sagw-6mt', 'transmissionassembly-and-csc-wia-6mt', 'transmissionassembly-tcu-and-csc-sagw-6amt'],
            'powertrain-control-diagnostic' => ['engine-management'],
            'powertrain-driver-interface' => ['accelerator-pedal', 'clutch-apply', 'clutch-apply-5mt', 'clutch-apply-5mt1', 'clutch-apply-6mt', 'transmission-operating-mechanism-6mt', 'transmission-operating-mechanism-6mt-e5', 'transmission-shift-actuation-mt-5mt', 'transmission-shift-actuation-mt-5mt1', 'transmission-shift-actuation-mt-6mt'],
            'rear-closure' => ['e-gate-handle-and-lock', 'endgate', 'rear-door', 'rear-door-check', 'rear-door-handle', 'rear-door-handle-and-door-lock', 'rear-door-hood', 'rear-door1'],
            'rear-lamp' => ['rear-lamp-parts'],
            'rear-view-mirror' => ['rear-view-mirror-parts'],
            'rearinterior-hvac-airflow' => ['interior-heating-pipe', 'interior-heating-pipe-front', 'interior-heating-pipe-rear', 'rear-interior-airflow'],
            'safety-avoidance' => ['air-bag-control-unit', 'park-distance-control-system'],
            'safety-belt' => ['merchandise-tether-treatment', 'safety-belt-driver、copilot', 'side-panel-roof-safety-belt'],
            'sealant-body-attachment' => ['body-attachment'],
            'seats' => ['11-seats', '2014-schoolbus-seat', '2015-school-seat', 'cf1-cf2-seat', 'driver-seat', 'driver-seat-left-hand', 'driver-seat-right-hand', 'driver-seat1', 'driver-seat2', 'driver-seat3', 'front-seat-left', 'front-seat-right', 'frt-dbl-seat', 'frt-dbl-seat-w-recl', 'frt-sin-seat', 'frt-sin-seat1', 'frt-sin-seat2', 'frt-sin-seat3', 'ix-seat', 'old-luxury-h-seat', 'rr-3-seat-w-recl', 'rr-dbl-seat-w-o-recl', 'rr-dbl-seat-w-recl', 'rr-dbl-seat-w-recl1', 'rr-sin-seat-w-recl', 'rr-sin-seat-w-recl1', 'rr-sin-wide-seat', 'single-seat-type', 'standard-12-16-seat', 'van-2-seat', 'van-3-seat'],
            'side-closures' => ['front-door-electric-glass-regulator', 'front-door-handle-and-lock', 'front-door-handleand-lock', 'front-side-closure', 'side-sliding-door', 'side-sliding-door-handle', 'side-sliding-door-handle-and-door-lock', 'side-sliding-door-handle-and-door-lock1', 'side-sliding-door-lock', 'side-sliding-door1', 'tnk-fil-dr'],
            'steering' => ['power-steering-plumbing-pipe', 'power-steering-plumbing-pipe1', 'redirector', 'redirector-left-hand', 'redirector-right-hand', 'steering-column'],
            'suspension' => ['five-bar-linkage-spiral-spring-rear-suspension', 'front-shock-absorber', 'front-suspension', 'rear-leaf-spring-suspension', 'rear-shock-absorber', 'rear-suspension'],
            'tirewheelswheel-trim' => ['tirewheeltrim'],
            'wiper-washer' => ['front-wiper', 'washer', 'wiper', 'wiper-lhd', 'wiper-rhd'],
        ],
        'new-deliver-9-diesel' => [
            'air-intake-system' => ['air-cleaner', 'air-filter'],
            'airbag' => ['steering-wheel-and-air-bag'],
            ...
            'body-upper-structure' => ['baffle-plate-ware', 'inner-framing-left-side', 'inner-framing-right-side', 'outer-framing-left-side', 'outer-framing-right-side', 'roof-framing'],
            'body-window' => ['window'],
            'brakes' => ['brake-apply', 'brake-apply-plumbing', 'brake-modulator', 'brake-pedal', 'brake-pedals', 'brake-pedals1', 'brake-pipes', 'brake-pipes-abs', 'brake-pipes-esp', 'brake-plumbing', 'front-brake-corner', 'front-brakes', 'park-brake', 'rear-brakes', 'rear-electric-parking-brakes', 'rear-mechanical-brakes'],
            'bumpersfascia-grille' => ['front-bumper', 'grille', 'rear-bumper', 'wheelhouse-liner'],
            'charging-energystorage' => ['battery-electrical-energy-storage', 'moudule-electric-vehicle-control-unit', 'moudule-electric-vehicle-control-unit-evcc', 'power-inverter', 'the-internal-parts-of-power-battery-77kwh-88-8kwh'],
            'chassis-structure' => ['frame', 'front-sub-frame', 'spare-tire-device'],
            'communicate' => ['vehicle-tele-communication'],
            ...
            'on-vehicle-attachments-tools' => ['fluids-and-lubrications', 'fluidsand-lubrications', 'lubricant', 'on-vehicle-attachments', 'on-vehicle-tools'],
            'power-energy-storage-link-wire' => ['battery-and-electric-drive-system', 'ept-system', 'ept-system2', 'ept-system3', 'the-internal-parts-of-reduction'],
            'power-generation' => ['accessory-accessory-drive', 'accessory-accessory-drive-d20', 'accessoryaccessory-drive-euro', 'accessoryaccessory-drive-euro-5', 'coolant-pump-and-inl-otlt-tube-d20', 'coolant-pump-and-inl-otlt-tube-thermostat', 'crankshaft-rod', 'crankshaft-rod-d20', 'cylinder-block-accessory', 'cylinder-block-accessory-d20', 'cylinder-blockcylinder-linerflywheel', 'cylinder-head', 'cylinder-head-d20', 'damper-pulley-gear-drive', 'egr-asm', 'egr-asm-d20', 'egr-asm-euro-5', 'engine-accessory', 'engine-accessory-euro-5', 'engine-asm', 'engine-shield', 'engine-wiring-harness', 'exhaust-elbow-turbocharger', 'exhaust-elbow-turbocharger-d20', 'exhaust-elbowturbocharger-euro-5', 'fuel-system', 'head-cover-pcv', 'head-cover-pcv-d20', 'manifold-asm-int', 'manifold-asm-int-d20', 'oil-cooler-and-inl-otlt-tube-filter', 'oil-cooler-and-inl-otlt-tube-filter-d20', 'oil-pumps-vacuum-pumps-vacuum-tube-components-d20', 'sensor-harness', 'sensor-harness-d20', 'sensorharness-euro', 'sensorharness-euro-5', 'shaft-balancer', 'shaft-balancer-d20', 'sump-oil-suction-pipe-dipstick', 'sump-oil-suction-pipe-dipstick-d20', 'sumpoil-suction-pipedipstickbalancer-euro-5', 'timing-drive', 'timing-drive-d20', 'uel-system-d20'],
            'power-signaldistribution' => ['battery-cable', 'battery-harness', 'battery-harnesses', 'body-accessories-harness', 'chassis-harnesses', 'door-wire-harnesses', 'engine-compartment-fuse-box', 'engine-compartment-harness', 'fusebox-engine-compartment', 'high-voltage-harness-ev-phev', 'instrument-panel-harness', 'instrument-panel-harness1', 'power-outlet-cigarette-lighter-application', 'power-outlet-cigarette-lighter-hevice'],
            'power-transmission' => ['clutch-housing-6mt-6amt', 'clutch-housing-6mt-front-drive-6amt', 'clutch-mt', 'clutch-phev', 'differential-sagw-6amt-6mt', 'manual-transmission-assembly', 'manual-transmission-assembly-6mt-front-back-drive', 'propeller-shaft', 'propshaft', 'rear-axle-front-drive-vehicle', 'rear-drive-axle', 'rear-driven-axle', 'transmission-accessory-5mt', 'transmission-accessory-6mt-front-drive', 'transmission-accessory-phev', 'transmission-accessory-sagw-6amt', 'transmission-assembly-6at', 'transmission-assembly-8at', 'transmission-body-5mt', 'transmission-body-sagw-6mt-6amt', 'transmission-csc-and-operating-mechanism-6mt-back-drive', 'transmission-differential-6mt-front-drive', 'transmission-differential-6mt-front-drive-6amt', 'transmission-fork-6mt-front-drive', 'transmission-fork-6mt-front-drive-6mt', 'transmission-fork-components-sagw-6mt-back-drive', 'transmission-main-shaft-and-gear-6mt-back-drive', 'transmission-operating-mechanism-6amt', 'transmission-operating-mechanism-6mt-front-drive', 'transmission-operating-mechanism-sagw-6mt', 'transmission-output-shaft-and-gear-wia-6mt', 'transmission-rvs-idler-shaft-gear-6mt-front-drive', 'transmission-rvs-idler-shaft-gear-6mt-front-drive-6amt', 'transmission-rvs-idler-shaft-gear-sagw-6amt-6mt', 'transmission-seal-6mt-front-drive', 'transmission-shaft-asm-6mt-front-drive', 'transmission-shaft-asm-6mt-front-drive-6amt', 'transmission-shaft-input-6mt-front-drive', 'transmission-shaft-input-6mt-front-drive-6amt', 'transmission-shaft-input-sagw-6mt-6amt', 'transmission-shaft-output-1256-6mt-front-drive', 'transmission-shaft-output-1256-6mt-front-drive-6amt', 'transmission-shaft-output-1256-sagw-6mt-6amt', 'transmission-shaft-output-34r-6mt-front-drive', 'transmission-shaft-output-34r-6mt-front-drive-6amt', 'transmission-shaft-output-34r-sagw-6mt-6amt', 'transmission-shell-6mt-6amt', 'transmission-shell-6mt-front-drive', 'transmission-shell-bearing-6mt-front-drive', 'transmission-shell-bearing-6mt-front-drive-6amt', 'transmission-shift-forks-sagw-6amt-6mt', 'transmissionassembly-and-accessory-sagw-6mt', 'transmissionassembly-tcu-and-csc-sagw-6amt'],
            'powertrain-control-diagnostic' => ['engine-management'],
            'powertrain-driver-interface' => ['accelerator-pedal', 'clutch-apply', 'clutch-apply-5mt', 'clutch-apply-5mt1', 'clutch-apply-6mt', 'transmission-operating-mechanism-6mt', 'transmission-operating-mechanism-6mt-e5', 'transmission-shift-actuation', 'transmission-shift-actuation-6amt', 'transmission-shift-actuation-6amt-9at', 'transmission-shift-actuation-amt', 'transmission-shift-actuation-at、electric-vehicle', 'transmission-shift-actuation-mt', 'transmission-shift-actuation-mt-5mt', 'transmission-shift-actuation-mt-5mt1', 'transmission-shift-actuation-mt-6mt'],
            'rear-closure' => ['endgate', 'rear-door', 'rear-door-handle', 'rear-door-handle-and-door-lock', 'rear-door-hood', 'rear-door1'],
            'rear-lamp' => ['rear-lamp-parts'],
            ...
            'safety-belt' => ['merchandise-tether-treatment', 'side-panel-roof-safety-belt'],
            'sealant-body-attachment' => ['body-attachment'],
            'seats' => ['arrangement-for-van-vehicle-uk、hong-kong', 'frong-seat-right', 'front-double-seats', 'front-manual-seat-left', 'front-manual-seat-right', 'front-seat-left', 'front-seat-right', 'rear-roll-double-seat', 'subdrivers-integral-double-seat', 'subdrivers-split-double-seat', 'subdrivers-split-double-seat1'],
            'side-closures' => ['front-door-electric-glass-regulator', 'front-door-handle-and-lock', 'front-door-handleand-lock', 'front-side-closure', 'rear-side-closure', 'side-sliding-door', 'side-sliding-door-guide-rail', 'side-sliding-door-handle-and-door-lock', 'side-sliding-door-handle-and-door-lock1', 'side-sliding-door-lock', 'side-sliding-door1', 'tnk-fil-dr'],
            'steering' => ['electirc-redirector-left-right-hand', 'redirector', 'redirector-left-hand', 'redirector-right-hand', 'steering-column'],
            'suspension' => ['five-bar-linkage-spiral-spring-rear-suspension', 'front-shock-absorber', 'front-suspension', 'rear-leaf-spring-suspension', 'rear-shock-absorber', 'rear-suspension'],
            'tirewheelswheel-trim' => ['tirewheeltrim'],
            'wiper-washer' => ['front-wiper', 'washer-system', 'wiper', 'wiper-lhd', 'wiper-rhd'],
        ...
        'new-t60-diesel' => [
            ...
            'body-upper-structure' => ['baffle-plate-ware', 'inner-framing', 'outer-framing', 'rear-framing', 'roof-framing'],
            'body-window' => ['window'],
            'brakes' => ['brake-apply', 'brake-apply-plumbing', 'brake-modulator', 'brake-pedal', 'brake-pipes', 'brake-pipes-abs', 'brake-pipes-esp', 'brake-plumbing', 'front-brakes', 'mechanical-parking-brakes', 'park-brake', 'rear-brake-corner', 'rear-brakes', 'rear-electric-parking-brakes', 'rear-mechanical-brakes'],
            'bumpersfascia-grille' => ['front-bumper', 'grille', 'rear-bumper', 'wheelhouse-liner'],
            'charging-energystorage' => ['battery-electrical-energy-storage', 'moudule-electric-vehicle-control-unit', 'power-battery-asm', 'power-battery-ev', 'the-internal-parts-of-power-battery-77kwh-88-8kwh'],
            'chassis-structure' => ['frame', 'spare-tire-device'],
            'communicate' => ['vehicle-tele-communication'],
            'customer-switches' => ['accessory-switch', 'accessory-switches', 'door-switches', 'ignition-switch-and-key', 'multi-function-column-switch', 'passive-entry-passive-start', 'window-lift-switch'],
            'driver-information' => ['auxiliary-information-electronics', 'clusters'],
    ...
    return isset($categories[$vehicle_slug]) ? $categories[$vehicle_slug] : [];
}
